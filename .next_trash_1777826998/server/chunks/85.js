  ...
  (exports.modules = {
    4085: (a, b, c) => {
      ...
      let g = [
        ...
        h = new Set(g),
        i = (a, b, c) => (c > b ? b : c < a ? a : c),
        j = { test: (a) => "number" == typeof a, parse: parseFloat, transform: (a) => a },
        k = { ...j, transform: (a) => i(0, 1, a) },
        l = { ...j, default: 1 },
        m = (a) => Math.round(1e5 * a) / 1e5,
        n = /-?(?:\d+(?:\.\d+)?|\.\d+)/gu,
        o =
          /^(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))$/iu,
        p = (a, b) => (c) =>
          !!(
            ("string" == typeof c && o.test(c) && c.startsWith(a)) ||
            (b && null != c && Object.prototype.hasOwnProperty.call(c, b))
          ),
        q = (a, b, c) => (d) => {
          if ("string" != typeof d) return d;
          let [e, f, g, h] = d.match(n);
          return {
            [a]: parseFloat(e),
            [b]: parseFloat(f),
            [c]: parseFloat(g),
        ...
        r = { ...j, transform: (a) => Math.round(i(0, 255, a)) },
        s = {
          test: p("rgb", "red"),
          parse: q("red", "green", "blue"),
        ...
        y = u("vh"),
        z = u("vw"),
        A = { ...w, parse: (a) => w.parse(a) / 100, transform: (a) => w.transform(100 * a) },
        B = {
          test: p("hsl", "hue"),
        ...
        C = {
          test: (a) => s.test(a) || t.test(a) || B.test(a),
          parse: (a) => (s.test(a) ? s.parse(a) : B.test(a) ? B.parse(a) : t.parse(a)),
          transform: (a) =>
            "string" == typeof a ? a : a.hasOwnProperty("red") ? s.transform(a) : B.transform(a),
          getAnimatableNone: (a) => {
            let b = C.parse(a);
            return ((b.alpha = 0), C.transform(b));
          },
        },
        D =
        ...
        let b = a.toString(),
          ...
          g = b
            .replace(
              ...
              (a) => (
                C.test(a)
                  ? (d.color.push(f), e.push(F), c.push(C.parse(a)))
                  : a.startsWith("var(")
                    ? (d.var.push(f), e.push("var"), c.push(a))
                    : (d.number.push(f), e.push(E), c.push(parseFloat(a))),
                ++f,
                "${}"
              ),
            )
      ...
      function I({ split: a, types: b }) {
        ...
        return (d) => {
          ...
          for (let f = 0; f < c; f++)
            if (((e += a[f]), void 0 !== d[f])) {
              let a = b[f];
              a === E ? (e += m(d[f])) : a === F ? (e += C.transform(d[f])) : (e += d[f]);
            }
          return e;
        };
      }
      let J = {
          test: function (a) {
            return (
              isNaN(a) &&
              "string" == typeof a &&
              (a.match(n)?.length || 0) + (a.match(D)?.length || 0) > 0
            );
          },
          parse: function (a) {
            return H(a).values;
      ...
      let M = /\b([a-z-]*)\(.*?\)/gu,
        ...
        S = (a) => R[a],
        T = () => ({ translate: 0, scale: 1, origin: 0, originPoint: 0 }),
        U = () => ({ x: T(), y: T() }),
        V = () => ({ min: 0, max: 0 }),
        W = () => ({ x: V(), y: V() }),
        X = (a) => !!(a && a.getVelocity),
        Y = new Set(["width", "height", "top", "left", "right", "bottom", ...g]),
        Z = (a) => (b) => b.test(a),
        $ = [j, x, w, v, z, y, { test: (a) => "auto" === a, parse: (a) => a }],
        _ = (a) => $.find(Z(a)),
        aa = () => {},
        ab = () => {},
        ac = (a) => /^-?(?:\d+(?:\.\d+)?|\.\d+)$/u.test(a),
        ad = (a) => (b) => "string" == typeof b && b.startsWith(a),
        ae = ad("--"),
        af = ad("var(--"),
        ag = (a) => !!af(a) && ah.test(a.split("/*")[0].trim()),
        ah = /var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu;
      function ai(a) {
        return "string" == typeof a && a.split("/*")[0].includes("var(--");
      }
      let aj = /^var\(--(?:([\w-]+)|([\w-]+), ?([a-zA-Z\d ()%#.,-]+))\)/u,
        ak = (a) => (180 * a) / Math.PI,
        al = (a) => an(ak(Math.atan2(a[1], a[0]))),
        am = {
          x: 4,
          y: 5,
          translateX: 4,
          ...
          rotate: al,
          rotateZ: al,
          skewX: (a) => ak(Math.atan(a[1])),
          skewY: (a) => ak(Math.atan(a[2])),
          skew: (a) => (Math.abs(a[1]) + Math.abs(a[2])) / 2,
        },
        an = (a) => ((a %= 360) < 0 && (a += 360), a),
        ao = (a) => Math.sqrt(a[0] * a[0] + a[1] * a[1]),
        ap = (a) => Math.sqrt(a[4] * a[4] + a[5] * a[5]),
        aq = {
          x: 12,
          y: 13,
          z: 14,
          ...
          scaleY: ap,
          scale: (a) => (ao(a) + ap(a)) / 2,
          rotateX: (a) => an(ak(Math.atan2(a[6], a[5]))),
          rotateY: (a) => an(ak(Math.atan2(-a[2], a[0]))),
          rotateZ: al,
          rotate: al,
          skewX: (a) => ak(Math.atan(a[4])),
          skewY: (a) => ak(Math.atan(a[1])),
      ...
      let au = (a) => a === j || a === x,
        ...
        ax = {
          ...
          x: (a, { transform: b }) => as(b, "x"),
          y: (a, { transform: b }) => as(b, "y"),
        };
      ((ax.translateX = ax.x), (ax.translateY = ax.y));
      let ay = (a) => a,
        az = {},
        aA = [
          "setup",
        ...
        aB = { value: null, addProjectionMetrics: null };
      function aC(a, b) {
        let c = !1,
          d = !0,
                ...
                let k = {
                  ...
                  process: (a) => {
                    ...
                    ((c = d),
                      (d = g),
                      c.forEach(j),
                      b && aB.value && aB.value.frameloop[b].push(i),
                      (i = 0),
                      c.clear(),
                      (e = !1),
                      f && ((f = !1), k.process(a)));
          ...
          p = () => {
            let f = az.useManualTiming,
              g = f ? e.timestamp : performance.now();
            ((c = !1),
              f || (e.delta = d ? 1e3 / 60 : Math.max(Math.min(g - e.timestamp, 40), 1)),
              (e.timestamp = g),
              (e.isProcessing = !0),
              h.process(e),
              i.process(e),
        ...
        return {
          ...
          cancel: (a) => {
            for (let b = 0; b < aA.length; b++) g[aA[b]].cancel(a);
          },
          state: e,
          steps: g,
        };
      ...
      let {
          ...
          state: aF,
          steps: aG,
        } = aC("undefined" != typeof requestAnimationFrame ? requestAnimationFrame : ay, !0),
        aH = new Set(),
        aI = !1,
        aJ = !1,
        aK = !1;
      function aL() {
        if (aJ) {
          let a = Array.from(aH).filter((a) => a.needsMeasurement),
        ...
        ((aJ = !1), (aI = !1), aH.forEach((a) => a.complete(aK)), aH.clear());
      }
      function aM() {
        aH.forEach((a) => {
          (a.readKeyframes(), a.needsMeasurement && (aJ = !0));
        });
      }
      class aN {
        ...
        scheduleResolve() {
          ((this.state = "scheduled"),
            this.isAsync
              ? (aH.add(this), aI || ((aI = !0), aD.read(aM), aD.resolveKeyframes(aL)))
        ...
        cancel() {
          "scheduled" === this.state && (aH.delete(this), (this.state = "pending"));
        }
        resume() {
          "pending" === this.state && this.scheduleResolve();
        }
      }
      let aO = (a) => /^0[^.\s]+$/u.test(a),
        aP = new Set([N, O]);
      function aQ(a, b) {
        let c = S(a);
        return (aP.has(c) || (c = J), c.getAnimatableNone ? c.getAnimatableNone(b) : void 0);
      }
      let aR = new Set(["auto", "none", "0"]);
      class aS extends aN {
        ...
        readKeyframes() {
          ...
          for (let c = 0; c < a.length; c++) {
            let d = a[c];
            if ("string" == typeof d && ag((d = d.trim()))) {
              let e = (function a(b, c, d = 1) {
                ...
                return ag(f) ? a(f, c, d + 1) : f;
              })(d, b.current);
              (void 0 !== e && (a[c] = e), c === a.length - 1 && (this.finalKeyframe = d));
            }
          }
          if ((this.resolveNoneKeyframes(), !Y.has(c) || 2 !== a.length)) return;
          let [d, e] = a,
            f = _(d),
            g = _(e);
          if (ai(d) !== ai(e) && ax[c]) {
          ...
          if (f !== g)
            ...
            else ax[c] && (this.needsMeasurement = !0);
        }
        resolveNoneKeyframes() {
          ...
          c.length &&
            (function (a, b, c) {
              ...
              for (; e < a.length && !d; ) {
                let b = a[e];
                ("string" == typeof b && !aR.has(b) && H(b).values.length && (d = a[e]), e++);
              }
              if (d && c) for (let e of b) a[e] = aQ(c, d);
            })(a, c, b);
        }
        measureInitialState() {
        ...
        measureEndState() {
          ...
          let e = c.length - 1,
            f = c[e];
          ((c[e] = ax[b](a.measureViewportBox(), window.getComputedStyle(a.current))),
      ...
      class aW {
        ...
        add(a) {
          return (aU(this.subscriptions, a), () => aV(this.subscriptions, a));
        }
        notify(a, b, c) {
      ...
      let a_ = a$(() => void 0 !== window.ScrollTimeline, "scrollTimeline"),
        a0 = (a) => null !== a;
      function a1(a, { repeat: b, repeatType: c = "loop" }, d, e = 1) {
        let f = a.filter(a0),
      ...
      let a3 = { layout: 0, mainThread: 0, waapi: 0 },
        a4 = (a) => Array.isArray(a) && "number" == typeof a[0],
        a5 = a$(() => {
          try {
        ...
        a7 = ([a, b, c, d]) => `cubic-bezier(${a}, ${b}, ${c}, ${d})`,
        a8 = {
          linear: "linear",
          ease: "ease",
          easeIn: "ease-in",
          ...
          circIn: a7([0, 0.65, 0.55, 1]),
          circOut: a7([0.55, 0, 1, 0.45]),
          backIn: a7([0.31, 0.01, 0.66, -0.59]),
          backOut: a7([0.33, 1.53, 0.69, 0.99]),
        };
      function a9(a) {
      ...
      class ba extends a2 {
          ...
          ((this.animation = (function (
              ...
              if (b)
                return "function" == typeof b
                  ...
                  : a4(b)
                    ? a7(b)
                    : Array.isArray(b)
                      ? b.map((b) => a(b, c) || a8.easeOut)
                      : a8[b];
            })(h, e);
            (Array.isArray(l) && (k.easing = l), aB.value && a3.waapi++);
            let m = {
              delay: d,
              duration: e,
            ...
            (this.animation.onfinish = () => {
              if (((this.finishedTime = this.time), !e)) {
                let a = a1(d, this.options, g, this.speed);
        ...
        set time(a) {
          ...
          ((this.manualStartTime = null),
            (this.finishedTime = null),
            (this.animation.currentTime = aT(a)),
      ...
      let bb = new Set(["opacity", "clipPath", "filter", "transform"]),
        { schedule: bc } = aC(queueMicrotask, !1);
      function bd() {
        d = void 0;
      }
      let be = {
          now: () => (
            void 0 === d &&
              be.set(aF.isProcessing || az.useManualTiming ? aF.timestamp : performance.now()),
            d
          ),
          set: (a) => {
            ((d = a), queueMicrotask(bd));
          },
        },
        bf = { current: void 0 };
      class bg {
        ...
        on(a, b) {
          this.events[a] || (this.events[a] = new aW());
        ...
        get() {
          return (bf.current && bf.current.push(this), this.current);
        }
        getPrevious() {
          return this.prev;
        }
        getVelocity() {
          var a;
          let b = be.now();
          if (!this.canTrackVelocity || void 0 === this.prevFrameValue || b - this.updatedAt > 30)
            return 0;
      ...
      let bm = [
        ...
        bn = ["initial", ...bm];
      function bo(a) {
        return bk(a.animate) || bn.some((b) => bl(a[b]));
      }
      function bp(a) {
        return !!(bo(a) || a.variants);
      }
      let bq = { current: null },
        br = { current: !1 },
      ...
      class bx {
          ...
          ((this.current = null),
            ...
            (this.scheduleRender = () => {
              ...
              this.renderScheduledAt < a &&
                ((this.renderScheduledAt = a), aD.render(this.render, !1, !0));
            }));
                      ...
                      if (((br.current = !0), bs))
                        if (window.matchMedia) {
                          let a = window.matchMedia("(prefers-reduced-motion)"),
                            b = () => (bq.current = a.matches);
                          (a.addEventListener("change", b), b());
                        } else bq.current = !1;
                    })(),
                  (this.shouldReduceMotion = bq.current)),
        ...
        bindToMotionValue(a, b) {
          ...
          if (
            ...
            b.accelerate && bb.has(a) && this.current instanceof HTMLElement)
          ) {
          ...
          let e = b.on("change", (b) => {
            ((this.latestValues[a] = b),
              this.props.onUpdate && aD.preRender(this.notifyUpdate),
        ...
        update(a, b) {
          ...
          ((this.prevMotionValues = (function (a, b, c) {
            for (let d in b) {
              let e = b[d],
                f = c[d];
              if (X(e)) a.addValue(d, e);
              else if (X(f)) a.addValue(d, bh(e, { owner: a }));
              else if (f !== e)
                if (a.hasValue(d)) {
                  let b = a.getValue(d);
                  ...
                  a.addValue(d, bh(void 0 !== b ? b : e, { owner: a }));
                }
            }
        ...
        getValue(a, b) {
          ...
          return (
            void 0 === c &&
              void 0 !== b &&
              ((c = bh(null === b ? void 0 : b, { owner: this })), this.addValue(a, c)),
            c
          );
        }
        readValue(a, b) {
          let c =
            void 0 === this.latestValues[a] && this.current
              ...
              : this.latestValues[a];
          if (null != c) {
            if ("string" == typeof c && (ac(c) || aO(c))) c = parseFloat(c);
            else {
              let d;
              ((d = c), !bi.find(Z(d)) && J.test(b) && (c = aQ(a, b)));
            }
            this.setBaseTarget(a, X(c) ? c.get() : c);
          }
          return X(c) ? c.get() : c;
        }
        setBaseTarget(a, b) {
        ...
        getBaseTarget(a) {
          ...
          if ("string" == typeof c || "object" == typeof c) {
            let d = bu(this.props, c, this.presenceContext?.custom);
            d && (b = d[a]);
          }
        ...
        on(a, b) {
          return (this.events[a] || (this.events[a] = new aW()), this.events[a].add(b));
        }
        notify(a, ...b) {
          this.events[a] && this.events[a].notify(...b);
        }
        scheduleRenderMicrotask() {
          bc.render(this.render);
        }
      }
      class by extends bx {
        constructor() {
      ...
      function bQ(a, b, c) {
        ...
        if (!d) return f;
        for (let b in d)
          (X(d[b]) || (e && X(e[b])) || bP(b, a) || c?.getValue(b)?.liveStyle !== void 0) &&
            (f[b] = d[b]);
        return f;
      }
      function bR(a, b, c) {
        ...
        for (let c in a)
          (X(a[c]) || X(b[c])) &&
            (d[-1 !== g.indexOf(c) ? "attr" + c.charAt(0).toUpperCase() + c.substring(1) : c] =
              a[c]);
        return d;
      }
      class bS extends by {
        ...
        readValueFromInstance(a, b) {
          ...
          return ((b = bI.has(b) ? b : bz(b)), a.getAttribute(b));
        }
        scrapeMotionValuesFromProps(a, b, c) {
          return bR(a, b, c);
        }
        ...
        renderInstance(a, b, c, d) {
          for (let c in (bK(a, b, void 0, d), b.attrs))
            a.setAttribute(bI.has(c) ? c : bz(c), b.attrs[c]);
        }
        mount(a) {
      ...
      function b$(a, { x: b, y: c }) {
        (bZ(a.x, b.translate, b.scale, b.originPoint),
          bZ(a.y, c.translate, c.scale, c.originPoint));
      }
      function b_(a, b) {
        ((a.min += b), (a.max += b));
      }
      function b0(a, b, c, d, e = 0.5) {
      ...
      function b2(a, b, c) {
        let d = c ?? a;
        (b0(a.x, b1(b.x, d.x), b.scaleX, b.scale, b.originX),
          b0(a.y, b1(b.y, d.y), b.scaleY, b.scale, b.originY));
      }
      function b3(a, b) {
        return bT(
          (function (a, b) {
        ...
        readValueFromInstance(a, b) {
                ...
                })(a, b);
          {
            let c = window.getComputedStyle(a),
              d = (ae(b) ? c.getPropertyValue(b) : c[b]) || 0;
      ...
      var b8 = c(21124),
        b9 = c(25880),
        ca = c(22577);
      let cb = (0, b5.createContext)({});
      function cc(a) {
        return Array.isArray(a) ? a.join(" ") : a;
      }
      let cd = () => ({ style: {}, transform: {}, transformOrigin: {}, vars: {} });
      function ce(a, b, c) {
        for (let d in b) X(b[d]) || bP(d, c) || (a[d] = b[d]);
      }
      let cf = () => ({ ...cd(), attrs: {} }),
        cg = new Set([
          "animate",
      ...
      try {
        !(function (a) {
          "function" == typeof a && (ci = (b) => (b.startsWith("on") ? !ch(b) : a(b)));
      ...
      var ck = c(21664),
        cl = c(62312);
      let cm = (a) => (b, c) => {
          let d = (0, b5.useContext)(cb),
            e = (0, b5.useContext)(ck.t),
            f = () =>
        ...
        cn = cm({ scrapeMotionValuesFromProps: bQ, createRenderState: cd }),
        co = cm({ scrapeMotionValuesFromProps: bR, createRenderState: cf }),
        cp = {
          animation: [
            "animate",
            "variants",
        ...
        cq = !1,
        cr = Symbol.for("motionComponentSymbol");
      function cs(a, { forwardMotionProps: b = !1, type: c } = {}, d, e) {
        d &&
          (function (a) {
            let b =
              (!(function () {
                if (cq) return;
                let a = {};
                for (let b in cp) a[b] = { isEnabled: (a) => cp[b].some((b) => !!a[b]) };
                ((bw = a), (cq = !0));
              })(),
              bw);
        ...
        function h(c, d) {
          let e,
            h = {
              ...(0, b5.useContext)(ca.Q),
              ...c,
              layoutId: (function ({ layoutId: a }) {
                let b = (0, b5.useContext)(b9.L).id;
            ...
            j = (function (a) {
              let { initial: b, animate: c } = (function (a, b) {
                if (bo(a)) {
                  ...
                  return { initial: !1 === b || bl(b) ? b : void 0, animate: bl(c) ? c : void 0 };
                }
                return !1 !== a.inherit ? b : {};
              })(a, (0, b5.useContext)(cb));
              return (0, b5.useMemo)(() => ({ initial: b, animate: c }), [cc(b), cc(c)]);
            })(c),
            k = g(c, i);
          return (0, b8.jsxs)(cb.Provider, {
            value: j,
            children: [
              e && j.visualElement
                ? (0, b8.jsx)(e, { visualElement: j.visualElement, ...h })
                : null,
                ...
                let h = (
                    (g ?? b7(a))
                      ? function (a, b, c, d) {
                          ...
                          if (a.style) {
                            let b = {};
                            (ce(b, a.style, a), (e.style = { ...b, ...e.style }));
                          }
                          return e;
                        }
                      : function (a, b) {
                              ...
                              return (
                                ...
                                Object.assign(
                                  ...
                                  (function ({ transformTemplate: a }, b) {
                                    return (0, b5.useMemo)(() => {
                                      let c = cd();
                                      return (bD(c, b, a), Object.assign({}, c.vars, c.style));
                                    }, [b]);
                                  })(a, b),
                                ),
                                d
                  ...
                  j = a !== b5.Fragment ? { ...i, ...h, ref: c } : {},
                  { children: k } = b,
                  l = (0, b5.useMemo)(() => (X(k) ? k.get() : k), [k]);
                return (0, b5.createElement)(a, { ...j, children: l });
              })(
                a,
                c,
                (function (a, b, c) {
                  let d = (0, b5.useRef)(c);
                  (0, b5.useInsertionEffect)(() => {
                    d.current = c;
                  });
                  let e = (0, b5.useRef)(null);
                  return (0, b5.useCallback)(
                    (c) => {
                      c && a.onMount?.(c);
                      let f = d.current;
      ...
      function cu(a, b, c) {
        let d = a.getProps();
        return bu(d, b, void 0 !== c ? c : d.custom, a);
      }
      function cv(a, b) {
        if (a?.inherit && b) {
          let { inherit: c, ...d } = a;
      ...
      let cx = (a) => Array.isArray(a);
      function cy(a, b) {
        let c = a.getValue("willChange");
        if (X(c) && c.add) return c.add(b);
        if (!c && az.WillChange) {
          let c = new az.WillChange("auto");
          (a.addValue("willChange", c), c.add(b));
        }
      }
      let cz = "data-" + bz("framerAppearId"),
        cA = (a, b) => (c) => b(a(c)),
        cB = (...a) => a.reduce(cA);
      function cC(a, b, c) {
            ...
            (c = (function ({ hue: a, saturation: b, lightness: c, alpha: d }) {
              ...
              if ((b /= 100)) {
                let d = c < 0.5 ? c * (1 + b) : c + b - c * b,
                  h = 2 * c - d;
                ((e = cC(h, d, a + 1 / 3)), (f = cC(h, d, a)), (g = cC(h, d, a - 1 / 3)));
              } else e = f = g = c;
              return {
      ...
      let cH = (a, b) => {
          let c = cG(a),
            d = cG(b);
          if (!c || !d) return cD(a, b);
          let e = { ...c };
          return (a) => (
            (e.red = cE(c.red, d.red, a)),
            (e.green = cE(c.green, d.green, a)),
            (e.blue = cE(c.blue, d.blue, a)),
            (e.alpha = bN(c.alpha, d.alpha, a)),
            s.transform(e)
          );
        },
        cI = new Set(["none", "hidden"]);
      function cJ(a, b) {
        return (c) => bN(a, b, c);
      }
      function cK(a) {
      ...
      function cM(a, b) {
        let c = { ...a, ...b },
          d = {};
        for (let e in c) void 0 !== a[e] && void 0 !== b[e] && (d[e] = cK(a[e])(a[e], b[e]));
        return (a) => {
      ...
      let cN = (a, b) => {
        let c = J.createTransformer(b),
          d = H(a),
          e = H(b);
        return d.indexes.var.length === e.indexes.var.length &&
          d.indexes.color.length === e.indexes.color.length &&
          d.indexes.number.length >= e.indexes.number.length
          ? (cI.has(a) && !e.values.length) || (cI.has(b) && !d.values.length)
            ? (function (a, b) {
                return cI.has(a) ? (c) => (c <= 0 ? a : b) : (c) => (c >= 1 ? b : a);
              })(a, b)
            : cB(
                cL(
                  (function (a, b) {
      ...
      let cP = (a) => {
        ...
        return {
          start: (a = !0) => aD.update(b, a),
          stop: () => aE(b),
          now: () => (aF.isProcessing ? aF.timestamp : be.now()),
        };
      };
      function cQ(a) {
        let b = 0,
      ...
      let cT = ["duration", "bounce"],
        cU = ["stiffness", "damping", "mass"];
      function cV(a, b) {
        return b.some((b) => void 0 !== a[b]);
      }
      function cW(a = cR.visualDuration, b = cR.bounce) {
        let c,
          d,
          e,
          f,
          g,
          h,
          j = "object" != typeof a ? { visualDuration: a, keyframes: [0, 1], bounce: b } : a,
          { restSpeed: k, restDelta: l } = j,
          m = j.keyframes[0],
          n = j.keyframes[j.keyframes.length - 1],
          o = { done: !1, value: m },
          {
            stiffness: p,
            damping: q,
            ...
            if (!cV(a, cU) && cV(a, cT))
              if (((b.velocity = 0), a.visualDuration)) {
                let c = (2 * Math.PI) / (1.2 * a.visualDuration),
                  d = c * c,
                  e = 2 * i(0.05, 1, 1 - (a.bounce || 0)) * Math.sqrt(d);
                b = { ...b, mass: cR.mass, stiffness: d, damping: e };
              } else {
                let c = (function ({
                  duration: a = cR.duration,
                  bounce: b = cR.bounce,
                  velocity: c = cR.velocity,
                  mass: d = cR.mass,
                }) {
                  let e, f;
                  aa(
                  ...
                  let g = 1 - b;
                  ((g = i(cR.minDamping, cR.maxDamping, g)),
                    (a = i(cR.minDuration, cR.maxDuration, a / 1e3)),
                    g < 1
                      ? ((e = (b) => {
                          let d = b * g,
                            e = d * a;
                          return 0.001 - ((d - c) / cS(b, g)) * Math.exp(-e);
                        }),
                        (f = (b) => {
                          let d = b * g * a,
                  ...
                  if (((a = aT(a)), isNaN(h)))
                    return { stiffness: cR.stiffness, damping: cR.damping, duration: a };
                  {
                    let b = Math.pow(h, 2) * d;
                    return { stiffness: b, damping: 2 * g * Math.sqrt(d * b), duration: a };
                  }
                })({ ...a, velocity: 0 });
                (b = { ...b, ...c, mass: cR.mass }).isResolvedFromDuration = !0;
              }
            return b;
          })({ ...j, velocity: -((j.velocity || 0) / 1e3) }),
          v = t || 0,
          w = q / (2 * Math.sqrt(p * r)),
          x = n - m,
          y = Math.sqrt(p / r) / 1e3,
          z = 5 > Math.abs(x);
        if (
          (k || (k = z ? cR.restSpeed.granular : cR.restSpeed.default),
          l || (l = z ? cR.restDelta.granular : cR.restDelta.default),
          w < 1)
        )
          ((e = cS(y, w)),
            (f = (v + w * y * x) / e),
            (c = (a) => n - Math.exp(-w * y * a) * (f * Math.sin(e * a) + x * Math.cos(e * a))),
            (g = w * y * f + x * e),
            (h = w * y * x - f * e),
            (d = (a) => Math.exp(-w * y * a) * (g * Math.sin(e * a) + h * Math.cos(e * a))));
        else if (1 === w) {
          c = (a) => n - Math.exp(-y * a) * (x + (v + y * x) * a);
          let a = v + y * x;
          d = (b) => Math.exp(-y * b) * (y * a * b - v);
        } else {
          let a = y * Math.sqrt(w * w - 1);
          c = (b) => {
            let c = Math.exp(-w * y * b),
              d = Math.min(a * b, 300);
            return n - (c * ((v + w * y * x) * Math.sinh(d) + a * x * Math.cosh(d))) / a;
          };
          let b = (v + w * y * x) / a,
            e = w * y * b - x * a,
            f = w * y * x - b * a;
        ...
        let A = {
          ...
          next: (a) => {
            if (!u && w < 1) {
              let b = Math.exp(-w * y * a),
                c = Math.sin(e * a),
                d = Math.cos(e * a),
                i = n - b * (f * c + x * d);
              return (
                (o.done = Math.abs(aT(b * (g * c + h * d))) <= k && Math.abs(n - i) <= l),
                (o.value = o.done ? n : i),
                o
              );
            }
            let b = c(a);
            return (
              u ? (o.done = a >= s) : (o.done = Math.abs(aT(d(a))) <= k && Math.abs(n - b) <= l),
              (o.value = o.done ? n : b),
              o
            );
          },
          toString: () => {
            let a = Math.min(cQ(A), 2e4),
              b = a6((b) => A.next(a * b).value, a, 30);
            return a + "ms " + b;
          },
          toTransition: () => {},
        };
      ...
      cW.applyToOptions = (a) => {
        ...
        return ((a.ease = b.ease), (a.duration = aT(b.duration)), (a.type = "keyframes"), a);
      };
      let cZ = (a, b, c) => (((1 - 3 * c + 3 * b) * a + (3 * c - 6 * b)) * a + 3 * b) * a;
      function c$(a, b, c, d) {
        return a === b && c === d
          ? ay
          : (e) =>
                ...
                : cZ(
                    (function (a, b, c, d, e) {
                      let f,
                        g,
                        h = 0;
                      do (f = cZ((g = b + (c - b) / 2), d, e) - a) > 0 ? (c = g) : (b = g);
      ...
      let c_ = c$(0.42, 0, 1, 1),
        c0 = c$(0, 0, 0.58, 1),
        c1 = c$(0.42, 0, 0.58, 1),
        c2 = (a) => (b) => (b <= 0.5 ? a(2 * b) / 2 : (2 - a(2 * (1 - b))) / 2),
        c3 = (a) => (b) => 1 - a(1 - b),
        c4 = c$(0.33, 1.53, 0.69, 0.99),
        c5 = c3(c4),
        c6 = c2(c5),
        c7 = (a) =>
          a >= 1 ? 1 : (a *= 2) < 1 ? 0.5 * c5(a) : 0.5 * (2 - Math.pow(2, -10 * (a - 1))),
        c8 = (a) => 1 - Math.sin(Math.acos(a)),
        c9 = c3(c8),
        da = c2(c8),
        db = {
          linear: ay,
        ...
        dc = (a) => {
          ...
          return "string" == typeof a
            ? (ab(void 0 !== db[a], `Invalid easing type '${a}'`, "invalid-easing-type"), db[a])
            : a;
        },
        dd = (a, b, c) => {
          let d = b - a;
      ...
      function de({ duration: a = 300, keyframes: b, times: c, ease: d = "easeInOut" }) {
        var e;
        let f = Array.isArray(d) && "number" != typeof d[0] ? d.map(dc) : dc(d),
          g = { done: !1, value: b[0] },
          h = (function (a, b, { clamp: c = !0, ease: d, mixer: e } = {}) {
            let f = a.length;
            if (
              (ab(
                f === b.length,
            ...
            let h = (function (a, b, c) {
                ...
                for (let c = 0; c < f; c++) {
                  let f = e(a[c], a[c + 1]);
                  (b && (f = cB(Array.isArray(b) ? b[c] || ay : b, f)), d.push(f));
                }
                return d;
              })(b, d, e),
              j = h.length,
              k = (c) => {
                ...
                let e = dd(a[d], a[d + 1], c);
                return h[d](e);
              };
            return c ? (b) => k(i(a[0], a[f - 1], b)) : k;
          })(
            ((e =
              c && c.length === b.length
                ? c
            ...
            e.map((b) => b * a)),
            b,
            { ease: Array.isArray(f) ? f : b.map(() => f || c1).splice(0, b.length - 1) },
          );
        return { calculatedDuration: a, next: (b) => ((g.value = h(b)), (g.done = b >= a), g) };
      }
      let df = { decay: cY, inertia: cY, tween: de, keyframes: de, spring: cW };
      function dg(a) {
        "string" == typeof a.type && (a.type = df[a.type]);
      }
      let dh = (a) => a / 100;
      class di extends a2 {
        constructor(a) {
          (super(),
            ...
            (this.stop = () => {
              ...
              (a && a.updatedAt !== be.now() && this.tick(be.now()),
                (this.isStopped = !0),
        ...
        initAnimation() {
          ...
          h !== de &&
            "number" != typeof g[0] &&
            ((this.mixKeyframes = cB(dh, cO(g[0], g[1]))), (g = [0, 100]));
          let i = h({ ...a, keyframes: g });
          ("mirror" === e &&
            (this.mirroredGenerator = h({ ...a, keyframes: [...g].reverse(), velocity: -f })),
            null === i.calculatedDuration && (i.calculatedDuration = cQ(i)));
        ...
        tick(a, b = !1) {
          ...
          let s = this.currentTime - k * (this.playbackSpeed >= 0 ? 1 : -1),
            t = this.playbackSpeed >= 0 ? s < 0 : s > e;
          ...
          if (m) {
            ...
            (!c && a >= 1 && (c = 1),
              1 === c && b--,
              (b = Math.min(b, m + 1)) % 2 &&
                ("reverse" === n ? ((c = 1 - c), o && (c -= o / h)) : "mirror" === n && (v = g)),
              (u = i(0, 1, c) * h));
          }
          (t ? ((this.delayState.value = l[0]), (c = this.delayState)) : (c = v.next(u)),
            f && !t && (c.value = f(c.value)));
          let { done: w } = c;
          t ||
            null === j ||
            (w = this.playbackSpeed >= 0 ? this.currentTime >= e : this.currentTime <= 0);
          let x =
            null === this.holdTime &&
            ("finished" === this.state || ("running" === this.state && w));
          return (
            x && p !== cY && (c.value = a1(l, this.options, r, this.speed)),
            q && q(c.value),
            x && this.finish(),
            c
          );
        ...
        getGeneratorVelocity() {
          ...
          return cX((a) => this.generator.next(a).value, a, b);
        }
        get speed() {
        ...
        set speed(a) {
          ...
          (b && this.driver && this.updateTime(be.now()),
            (this.playbackSpeed = a),
            b && this.driver && (this.time = this.currentTime / 1e3));
        }
        play() {
          if (this.isStopped) return;
          let { driver: a = cP, startTime: b } = this.options;
      ...
      let dj = { anticipate: c7, backInOut: c6, circInOut: da };
      class dk extends ba {
        constructor(a) {
          (!(function (a) {
            "string" == typeof a.ease && a.ease in dj && (a.ease = dj[a.ease]);
          })(a),
            dg(a),
            super(a),
        ...
        updateMotionValue(a) {
          ...
          let g = new di({ ...f, autoplay: !1 }),
            h = Math.max(10, be.now() - this.startTime),
            j = i(0, 10, h - 10),
            k = g.sample(h).value,
            { name: l } = this.options;
          (e && l && aX(e, l, k),
            b.setWithVelocity(g.sample(Math.max(0, h - j)).value, k, j),
            g.stop());
        }
      }
      let dl = (a, b) =>
      ...
      let dn = /^(?:oklch|oklab|lab|lch|color|color-mix|light-dark)\(/,
        dp = new Set([
          "color",
          "backgroundColor",
          "outlineColor",
        ...
        dq = aY(() => Object.hasOwnProperty.call(Element.prototype, "animate"));
      class dr extends a2 {
        constructor({
          autoplay: a = !0,
          delay: b = 0,
        ...
        onKeyframesResolved(a, b, c, d) {
          ...
          !(function (a, b, c, d) {
            ...
            ((l = !1),
            (az.instantAnimations || !i) && k?.(a1(a, c, b)),
            (a[0] = a[a.length - 1]),
            dm(c),
            (c.repeat = 0));
          let m = {
                ...
                return (
                  ...
                  (bb.has(c) ||
                    (dp.has(c) &&
                      (function (a) {
                        for (let b = 0; b < a.length; b++)
                          if ("string" == typeof a[b] && dn.test(a[b])) return !0;
                        return !1;
                      })(h))) &&
                  ("transform" !== c || !j) &&
                  !i &&
        ...
        get animation() {
          return (
            this._animation || (this.keyframeResolver?.resume(), (aK = !0), aM(), aL(), (aK = !1)),
            this._animation
          );
        }
        get duration() {
      ...
      let ds = { type: "spring", stiffness: 500, damping: 25, restSpeed: 10 },
        dt = { type: "keyframes", duration: 0.8 },
        du = { type: "keyframes", ease: [0.25, 0.1, 0.35, 1], duration: 0.3 },
        dv = new Set([
          "when",
          "delay",
          "delayChildren",
        ...
        dw =
          ...
          (g) => {
            ...
            (!(function (a) {
              for (let b in a) if (!dv.has(b)) return !0;
              return !1;
            })(i) &&
              Object.assign(
                l,
              ...
              l.duration && (l.duration = aT(l.duration)),
              l.repeatDelay && (l.repeatDelay = aT(l.repeatDelay)),
              void 0 !== l.from && (l.keyframes[0] = l.from));
            let m = !1;
            if (
              ((!1 !== l.type && (0 !== l.duration || l.repeatDelay)) ||
                (dm(l), 0 === l.delay && (m = !0)),
              (az.instantAnimations || az.skipAnimations || e?.shouldSkipAnimations) &&
                ((m = !0), dm(l), (l.delay = 0)),
              (l.allowFlatten = !i.type && !i.ease),
              m && !f && void 0 !== b.get())
            ) {
              let a = a1(l.keyframes, i);
              if (void 0 !== a)
                return void aD.update(() => {
                  (l.onUpdate(a), l.onComplete());
                });
            }
            return i.isSync ? new di(l) : new dr(l);
          };
      function dx(a, b, { delay: c = 0, transitionOverride: d, type: e } = {}) {
        ...
        for (let b in h) {
          ...
          if (window.MotionHandoffAnimation) {
            let c = a.props[cz];
            if (c) {
              let a = window.MotionHandoffAnimation(c, b, aD);
              null !== a && ((g.startTime = a), (m = !0));
            }
          }
          cy(a, b);
          let n = j ?? a.shouldReduceMotion;
          d.start(dw(b, d, e, n && Y.has(b) ? { type: !1 } : g, a, m));
          let o = d.animation;
          o && k.push(o);
        }
        if (g) {
          let b = () =>
            aD.update(() => {
              g &&
                (function (a, b) {
                  let { transitionEnd: c = {}, transition: d = {}, ...e } = cu(a, b) || {};
                  for (let b in (e = { ...e, ...c })) {
                    var f;
                    let c = cx((f = e[b])) ? f[f.length - 1] || 0 : f;
                    a.hasValue(b) ? a.getValue(b).set(c) : a.addValue(b, bh(c));
                  }
                })(a, g);
            });
      ...
      function dz(a, b, c = {}) {
        let d = cu(a, b, "exit" === c.type ? a.presenceContext?.custom : void 0),
          { transition: e = a.getDefaultTransition() || {} } = d || {};
        c.transitionOverride && (e = c.transitionOverride);
        let f = d ? () => Promise.all(dx(a, d, c)) : () => Promise.resolve(),
          g =
      ...
      class dG extends ct {
            ...
            a.animationState ||
              (a.animationState = (function (a) {
                let b = (b) =>
                      ...
                      b.map(({ animation: b, options: c }) =>
                        (function (a, b, c = {}) {
                          ...
                          if ((a.notify("AnimationStart", b), Array.isArray(b)))
                            d = Promise.all(b.map((b) => dz(a, b, c)));
                          else if ("string" == typeof b) d = dz(a, b, c);
                          else {
                            let e = "function" == typeof b ? cu(a, b, c.custom) : b;
                            d = Promise.all(dx(a, e, c));
                          }
                          return d.then(() => {
                  ...
                  e = !1,
                  f = (b) => (c, d) => {
                    let e = cu(a, d, "exit" === b ? a.presenceContext?.custom : void 0);
                    if (e) {
                ...
                function g(g) {
                  ...
                  for (let b = 0; b < dD; b++) {
                    ...
                    let v =
                        ((n = q.prevProp),
                        "string" == typeof (o = r) ? o !== n : !!Array.isArray(o) && !dB(o, n)),
                        ...
                        ...y.map((b) => {
                          ...
                          if (
                            ...
                            if (d.enteringChildren && e) {
                              ...
                              c.delay = dy(d.enteringChildren, a, b);
                            }
                          }
                  ...
                  if (k.size) {
                    ...
                    if ("boolean" != typeof h.initial) {
                      let c = cu(a, Array.isArray(h.initial) ? h.initial[0] : h.initial);
        ...
        updateAnimationControlsSubscription() {
          ...
          bk(a) && (this.unmountControls = a.subscribe(this.node));
        }
        mount() {
      ...
      class dI extends ct {
        constructor() {
          (super(...arguments), (this.id = dH++), (this.isExitComplete = !1));
        }
        update() {
      ...
      function dN(a, b, c, d) {
        (dM(a.x, b.x, c.x, d ? d.originX : void 0), dM(a.y, b.y, c.y, d ? d.originY : void 0));
      }
      function dO(a, b, c, d = 0) {
        ((a.min = (d ? bN(c.min, c.max, d) : c.min) + b.min), (a.max = a.min + dL(b)));
      }
      function dP(a, b, c, d = 0) {
        let e = d ? bN(c.min, c.max, d) : c.min;
        ((a.min = b.min - e), (a.max = a.min + dL(b)));
      }
      function dQ(a, b, c, d) {
        (dP(a.x, b.x, c.x, d?.x), dP(a.y, b.y, c.y, d?.y));
      }
      let dR = new Set(["BUTTON", "INPUT", "SELECT", "TEXTAREA", "A"]),
        dS = new Set(["INPUT", "SELECT", "TEXTAREA"]);
      function dT(a, b, c, d = { passive: !0 }) {
        return (a.addEventListener(b, c, d), () => a.removeEventListener(b, c));
      }
      var dU = c(35590);
      function dV(a) {
        return (0, dU.G)(a) && "ownerSVGElement" in a;
      }
      function dW(a, b, c) {
        if (null == a) return [];
      ...
      let dX = new WeakMap(),
        dY = (a, b, c) => (d, e) =>
          e && e[0] ? e[0][a + "Size"] : dV(d) && "getBBox" in d ? d.getBBox()[b] : d[c],
        dZ = dY("inline", "width", "offsetWidth"),
        d$ = dY("block", "height", "offsetHeight");
      function d_({ target: a, borderBoxSize: b }) {
        dX.get(a)?.forEach((c) => {
          c(a, {
            get width() {
              return dZ(a, b);
          ...
          ? (d1.add(a),
            ...
            () => {
              (d1.delete(a),
                d1.size ||
                  "function" != typeof f ||
                  (window.removeEventListener("resize", f), (f = void 0)));
            })
          : (function (a, b) {
              e || ("undefined" != typeof ResizeObserver && (e = new ResizeObserver(d0)));
              let c = dW(a);
              return (
                c.forEach((a) => {
                  let c = dX.get(a);
                  (c || ((c = new Set()), dX.set(a, c)), c.add(b), e?.observe(a));
                }),
                () => {
                  c.forEach((a) => {
                    let c = dX.get(a);
                    (c?.delete(b), c?.size || e?.unobserve(a));
                  });
                }
              );
            })(a, b);
      ...
      function d5(a, b, c, d) {
        return dT(a, b, (a) => d3(a) && c(a, d4(a)), d);
      }
      let d6 = ({ current: a }) => (a ? a.ownerDocument.defaultView : null);
      function d7(a) {
        return a && "object" == typeof a && Object.prototype.hasOwnProperty.call(a, "current");
      }
      let d8 = (a, b) => Math.abs(a - b),
        d9 = new Set(["auto", "scroll"]);
      class ea {
        constructor(
          a,
          b,
          ...
          if (
            ...
            (this.updatePoint = () => {
              ...
              this.lastRawMoveEventInfo &&
                (this.lastMoveEventInfo = eb(this.lastRawMoveEventInfo, this.transformPagePoint));
              let a = ed(this.lastMoveEventInfo, this.history),
                b = null !== this.startEvent,
                c =
                  (function (a, b) {
                    return Math.sqrt(d8(a.x, b.x) ** 2 + d8(a.y, b.y) ** 2);
            ...
            (this.handlePointerMove = (a, b) => {
              ((this.lastMoveEvent = a),
                ...
                (this.lastMoveEventInfo = eb(b, this.transformPagePoint)),
                aD.update(this.updatePoint, !0));
            }),
          ...
          let h = eb(d4(a), this.transformPagePoint),
            { point: i } = h,
            { timestamp: j } = aF;
          this.history = [{ ...i, timestamp: j }];
          let { onSessionStart: k } = b;
          (k && k(a, ed(h, this.history)),
            (this.removeListeners = cB(
              d5(this.contextWindow, "pointermove", this.handlePointerMove),
              d5(this.contextWindow, "pointerup", this.handlePointerUp),
              d5(this.contextWindow, "pointercancel", this.handlePointerUp),
            )),
        ...
        startScrollTracking(a) {
          ...
          for (; b; ) {
            ...
            ((d9.has(a.overflowX) || d9.has(a.overflowY)) &&
        ...
        return {
          ...
          velocity: (function (a, b) {
            ...
            let c = a.length - 1,
              d = null,
              e = ee(a);
            for (; c >= 0 && ((d = a[c]), !(e.timestamp - d.timestamp > aT(0.1))); ) c--;
            if (!d) return { x: 0, y: 0 };
            d === a[0] && a.length > 2 && e.timestamp - d.timestamp > 2 * aT(b) && (d = a[1]);
      ...
      class ek {
        ...
        start(a, { snapToCursor: b = !1, distanceThreshold: c } = {}) {
          ...
          let e = (a) => {
              (b && this.snapToCursor(d4(a).point), this.stopAnimation());
            },
            f = (a, b) => {
                ...
                dK((a) => {
                  ...
                  if (w.test(b)) {
                    ...
                    if (c && c.layout) {
                      ...
                      d && (b = dL(d) * (parseFloat(b) / 100));
                    }
                  }
                  this.originPoint[a] = b;
                }),
                e && aD.update(() => e(a, b), !1, !0),
                cy(this.visualElement, "transform"));
          ...
          this.panSession = new ea(
            ...
            { onSessionStart: e, onStart: f, onMove: g, onSessionEnd: h, resumeAnimation: i },
            {
              ...
              dragSnapToOrigin: j,
              distanceThreshold: c,
              contextWindow: d6(this.visualElement),
        ...
        updateAxis(a, b, c) {
          ...
          if (!c || !em(a, d, this.currentDirection)) return;
          ...
          (a && d7(a)
            ...
            : a && c
              ? (this.constraints = (function (a, { top: b, left: c, bottom: d, right: e }) {
                  return { x: ef(a.x, c, e), y: ef(a.y, b, d) };
                })(c.layoutBox, a))
              : (this.constraints = !1),
            (this.elastic = (function (a = 0.35) {
              return (
                !1 === a ? (a = 0) : !0 === a && (a = 0.35),
                { x: eh(a, "left", "right"), y: eh(a, "top", "bottom") }
              );
            })(b)),
            d !== this.constraints &&
              !d7(a) &&
        ...
        resolveRefConstraints() {
          ...
          let f = (function (a, b, c) {
              let d = b3(a, c),
                { scroll: e } = b;
              return (e && (b_(d.x, e.offset.x), b_(d.y, e.offset.y)), d);
            })(d, e.root, this.visualElement.getTransformPagePoint()),
            g = ((a = e.layout.layoutBox), { x: eg(a.x, f.x), y: eg(a.y, f.y) });
          if (c) {
            let a = c(
              (function ({ x: a, y: b }) {
        ...
        startAnimation(a) {
          ...
          return Promise.all(
            dK((g) => {
              if (!em(g, b, this.currentDirection)) return;
              let i = (h && h[g]) || {};
        ...
        startAxisValueAnimation(a, b) {
          ...
          return (cy(this.visualElement, a), c.start(dw(a, c, 0, b, this.visualElement, !1)));
        }
        stopAnimation() {
          dK((a) => this.getAxisMotionValue(a).stop());
        }
        ...
        snapToCursor(a) {
          dK((b) => {
            ...
            if (!em(b, c, this.currentDirection)) return;
        ...
        scalePositionWithinConstraints() {
          ...
          if (!d7(b) || !c || !this.constraints) return;
          this.stopAnimation();
          let d = { x: 0, y: 0 };
          dK((a) => {
            ...
            if (b && !1 !== this.constraints) {
              ...
              d[a] = (function (a, b) {
                ...
                return (
                  e > d
                    ? (c = dd(b.min, b.max - d, a.min))
                    : d > e && (c = dd(a.min, a.max - e, b.min)),
                  i(0, 1, c)
                );
        ...
        addListeners() {
          ...
          let b = this.visualElement.current,
            c = d5(b, "pointerdown", (a) => {
              let { drag: c, dragListener: d = !0 } = this.getProps(),
                e = a.target,
                f = e !== b && (dS.has(e.tagName) || !0 === e.isContentEditable);
              c && d && !f && this.start(a);
            }),
            d = () => {
          ...
          (e && !e.layout && (e.root && e.root.updateScroll(), e.updateLayout()), aD.read(d));
          let g = dT(window, "resize", () => this.scalePositionWithinConstraints()),
      ...
      class en extends ct {
        constructor(a) {
          (super(a),
            (this.removeGroupControls = ay),
            (this.removeListeners = ay),
            (this.controls = new ek(a)));
        }
        mount() {
          let { dragControls: a } = this.node.getProps();
          (a && (this.removeGroupControls = a.subscribe(this.controls)),
            (this.removeListeners = this.controls.addListeners() || ay));
        }
        update() {
          let { dragControls: a } = this.node.getProps(),
      ...
      let eo = (a) => (b, c) => {
        a && aD.update(() => a(b, c), !1, !0);
      };
      class ep extends ct {
        constructor() {
          (super(...arguments), (this.removePointerDownListener = ay));
        }
        onPointerDown(a) {
          this.session = new ea(a, this.createPanHandlers(), {
            transformPagePoint: this.node.getTransformPagePoint(),
            contextWindow: d6(this.node),
          });
        }
        createPanHandlers() {
          ...
          return {
            ...
            onMove: eo(c),
            onEnd: (a, b) => {
              (delete this.session, d && aD.postRender(() => d(a, b)));
            },
          };
        }
        mount() {
          this.removePointerDownListener = d5(this.node.current, "pointerdown", (a) =>
      ...
      let eq = { hasAnimatedSinceResize: !0, hasEverUpdated: !1 };
      var er = c(92323);
      let es = (0, b5.createContext)({}),
        et = !1;
      class eu extends b5.Component {
        componentDidMount() {
      ...
      function ev(a) {
        let [b, c] = (0, er.xQ)(),
          d = (0, b5.useContext)(b9.L);
        return (0, b8.jsx)(eu, {
          ...a,
          layoutGroup: d,
          switchLayoutGroup: (0, b5.useContext)(es),
          isPresent: b,
          safeToRemove: c,
        });
      }
      let ew = [
        ...
        ex = ew.length,
        ey = (a) => ("string" == typeof a ? parseFloat(a) : a),
        ez = (a) => "number" == typeof a || x.test(a);
      function eA(a, b) {
      ...
      let eB = eD(0, 0.5, c9),
        eC = eD(0.5, 0.95, ay);
      function eD(a, b, c) {
        return (d) => (d < a ? 0 : d > b ? 1 : c(dd(a, b, d)));
      }
      function eE(a, b) {
        ((a.min = b.min), (a.max = b.max));
      }
      function eF(a, b) {
        (eE(a.x, b.x), eE(a.y, b.y));
      }
      function eG(a, b) {
      ...
      function eI(a, b, [c, d, e], f, g) {
        !(function (a, b = 0, c = 1, d = 0.5, e, f = a, g = a) {
          if (
            (w.test(b) && ((b = parseFloat(b)), (b = bN(g.min, g.max, b / 100) - g.min)),
            "number" != typeof b)
          )
            return;
          let h = bN(f.min, f.max, d);
          (a === f && (h -= b), (a.min = eH(a.min, b, c, h, e)), (a.max = eH(a.max, b, c, h, e)));
        })(a, b[c], b[d], b[e], b.scale, f, g);
      }
      let eJ = ["x", "scaleX", "originX"],
        eK = ["y", "scaleY", "originY"];
      function eL(a, b, c, d) {
        (eI(a.x, b, eJ, c ? c.x : void 0, d ? d.x : void 0),
          eI(a.y, b, eK, c ? c.y : void 0, d ? d.y : void 0));
      }
      function eM(a) {
        return 0 === a.translate && 1 === a.scale;
      }
      function eN(a) {
        return eM(a.x) && eM(a.y);
      }
      function eO(a, b) {
      ...
      function eQ(a, b) {
        return eP(a.x, b.x) && eP(a.y, b.y);
      }
      function eR(a) {
        return dL(a.x) / dL(a.y);
      }
      function eS(a, b) {
        return (
      ...
      class eT {
        ...
        add(a) {
          ...
          for (let b = this.members.length - 1; b >= 0; b--) {
            ...
            let d = c.instance;
            (d && !1 !== d.isConnected) || c.snapshot || (aV(this.members, c), c.unmount());
          }
          a.scheduleRender();
        }
        remove(a) {
          if (
            (aV(this.members, a), a === this.prevLead && (this.prevLead = void 0), a === this.lead)
          ) {
      ...
      class eV {
        ...
        remove(a) {
          (aV(this.children, a), (this.isDirty = !0));
        }
        forEach(a) {
          (this.isDirty && this.children.sort(eU), (this.isDirty = !1), this.children.forEach(a));
        }
      }
      let eW = { nodes: 0, calculatedTargetDeltas: 0, calculatedProjections: 0 },
        eX = ["", "X", "Y", "Z"],
        eY = 0;
      function eZ(a, b, c, d) {
      ...
      function e$({
        ...
        return class {
          constructor(a = {}, c = b?.()) {
            ((this.id = eY++),
              ...
              (this.updateProjection = () => {
                ((this.projectionUpdateScheduled = !1),
                  aB.value && (eW.nodes = eW.calculatedTargetDeltas = eW.calculatedProjections = 0),
                  this.nodes.forEach(e1),
                  this.nodes.forEach(fa),
                  this.nodes.forEach(fb),
                  this.nodes.forEach(e2),
                  aB.addProjectionMetrics && aB.addProjectionMetrics(eW));
              }),
          ...
          addEventListener(a, b) {
            return (
              this.eventHandlers.has(a) || this.eventHandlers.set(a, new aW()),
          ...
          mount(b) {
            ...
            ((this.isSVG = dV(b) && !(dV(b) && "svg" === b.tagName)), (this.instance = b));
                ...
                a(b, () => {
                  ...
                  a !== d &&
                    ...
                    (c = (function (a, b) {
                      ...
                      return (aD.setup(d, !0), () => aE(d));
                    })(e, 250)),
                    eq.hasAnimatedSinceResize &&
                      ((eq.hasAnimatedSinceResize = !1), this.nodes.forEach(e9)));
                }));
            }
              ...
              !1 !== this.options.animate &&
                ...
                this.addEventListener(
                  ...
                  ({ delta: a, hasLayoutChanged: b, hasRelativeLayoutChanged: c, layout: d }) => {
                    ...
                    let f = this.options.transition || e.getDefaultTransition() || fh,
                      { onLayoutAnimationStart: g, onLayoutAnimationComplete: h } = e.getProps(),
                      i = !this.targetLayout || !eQ(this.targetLayout, d),
                      j = !b && c;
                    if (
                      ...
                      let b = { ...cw(f, "layout"), onPlay: g, onComplete: h };
          ...
          startUpdate() {
            !this.isUpdateBlocked() &&
              ((this.isUpdating = !0), this.nodes && this.nodes.forEach(fc), this.animationId++);
          }
              ...
              (window.MotionCancelOptimisedAnimation &&
                ...
                (function a(b) {
                  ...
                  if (window.MotionHasOptimisedAnimation(d, "transform")) {
                    ...
                    window.MotionCancelOptimisedAnimation(d, "transform", aD, !(a || c));
                  }
                  let { parent: e } = b;
          ...
          update() {
            if (((this.updateScheduled = !1), this.isUpdateBlocked())) {
              ...
              (this.unblockUpdate(),
                ...
                a && this.nodes.forEach(e5),
                this.nodes.forEach(e4));
              return;
            }
            if (this.animationId <= this.animationCommitId) return void this.nodes.forEach(e6);
            ((this.animationCommitId = this.animationId),
              ...
              this.clearAllSnapshots());
            let a = be.now();
            ((aF.delta = i(0, 1e3 / 60, a - aF.timestamp)),
              (aF.timestamp = a),
              (aF.isProcessing = !0),
              aG.update.process(aF),
              aG.preRender.process(aF),
              aG.render.process(aF),
              (aF.isProcessing = !1));
          }
          didUpdate() {
          ...
          clearAllSnapshots() {
            (this.nodes.forEach(e3), this.sharedNodes.forEach(fd));
          }
          scheduleUpdateProjection() {
            this.projectionUpdateScheduled ||
              ((this.projectionUpdateScheduled = !0), aD.preRender(this.updateProjection, !1, !0));
          }
          ...
          updateSnapshot() {
            !this.snapshot &&
              ...
              !this.snapshot ||
                dL(this.snapshot.measuredBox.x) ||
                dL(this.snapshot.measuredBox.y) ||
          ...
          resetTransform() {
            ...
            let a =
              ...
              b = this.projectionDelta && !eN(this.projectionDelta),
          ...
          measurePageBox() {
            ...
            if (!(this.scroll?.wasRoot || this.path.some(fm))) {
              let { scroll: a } = this.root;
              a && (b_(b.x, a.offset.x), b_(b.y, a.offset.y));
            }
            return b;
          }
          removeElementScroll(a) {
            let b = W();
            if ((eF(b, a), this.scroll?.wasRoot)) return b;
            for (let c = 0; c < this.path.length; c++) {
              ...
              d !== this.root &&
                e &&
                f.layoutScroll &&
                (e.wasRoot && eF(b, a), b_(b.x, e.offset.x), b_(b.y, e.offset.y));
            }
            return b;
          }
          applyTransform(a, b = !1, c) {
            ...
            for (let a = 0; a < this.path.length; a++) {
              ...
              (!b &&
                ...
                c.scroll &&
                c !== c.root &&
                (b_(d.x, -c.scroll.offset.x), b_(d.y, -c.scroll.offset.y)),
                bW(c.latestValues) && b2(d, c.latestValues, c.layout?.layoutBox));
            }
            return (bW(this.latestValues) && b2(d, this.latestValues, this.layout?.layoutBox), d);
          }
          removeTransform(a) {
            let b = W();
            eF(b, a);
            for (let a = 0; a < this.path.length; a++) {
              ...
              bW(d.latestValues) &&
                (d.instance &&
                  (bV(d.latestValues) && d.updateSnapshot(), eF((c = W()), d.measurePageBox())),
                eL(b, d.latestValues, d.snapshot?.layoutBox, c));
            }
            return (bW(this.latestValues) && eL(b, this.latestValues), b);
          }
          setTargetDelta(a) {
            ((this.targetDelta = a),
          ...
          forceRelativeParentToResolveTarget() {
            this.relativeParent &&
              this.relativeParent.resolvedRelativeTargetAt !== aF.timestamp &&
          ...
          resolveTargetDelta(a = !1) {
            ...
            this.resolvedRelativeTargetAt = aF.timestamp;
              ...
              if (
                ...
                this.targetDelta
                  ? (this.resumingFrom
                    ...
                    b$(this.target, this.targetDelta))
                  : eF(this.target, this.layout.layoutBox);
              (this.attemptToResolveRelativeTarget &&
                ...
                aB.value && eW.calculatedTargetDeltas++);
            }
          }
          ...
          createRelativeTarget(a, b, c) {
            ((this.relativeParent = a),
              ...
              dQ(this.relativeTargetOrigin, b, c, this.options.layoutAnchor || void 0),
          ...
          calcProjection() {
            ...
            if (
              ...
              this.resolvedRelativeTargetAt === aF.timestamp && (c = !1),
              c)
            )
              return;
            let { layout: d, layoutId: e } = this.options;
            ...
            (!(function (a, b, c, d = !1) {
                ...
                for (let h = 0; h < g; h++) {
                  ...
                  (!g || !g.props.style || "contents" !== g.props.style.display) &&
                    (d &&
                      ...
                      e.scroll &&
                      e !== e.root &&
                      (b_(a.x, -e.scroll.offset.x), b_(a.y, -e.scroll.offset.y)),
                    f && ((b.x *= f.x.scale), (b.y *= f.y.scale), b$(a, f)),
                    d && bW(e.latestValues) && b2(a, e.latestValues, e.layout?.layoutBox));
                }
              ...
              a.layout &&
                ...
                ((a.target = a.layout.layoutBox), (a.targetWithTransforms = W())));
            let { target: h } = a;
            if (!h) {
            ...
            (this.projectionDelta && this.prevProjectionDelta
              ? (eG(this.prevProjectionDelta.x, this.projectionDelta.x),
                eG(this.prevProjectionDelta.y, this.projectionDelta.y))
              : this.createProjectionDeltas(),
              dN(this.projectionDelta, this.layoutCorrected, h, this.latestValues),
              (this.treeScale.x === f &&
                this.treeScale.y === g &&
                eS(this.projectionDelta.x, this.prevProjectionDelta.x) &&
                eS(this.projectionDelta.y, this.prevProjectionDelta.y)) ||
                ((this.hasProjected = !0),
                this.scheduleRender(),
                this.notifyListeners("projectionUpdate", h)),
              aB.value && eW.calculatedProjections++);
          }
          hide() {
            this.isVisible = !1;
          }
          ...
          createProjectionDeltas() {
            ((this.prevProjectionDelta = U()),
              (this.projectionDelta = U()),
              (this.projectionDeltaWithTransform = U()));
          }
          setAnimationOrigin(a, b = !1) {
            ...
            let h = W(),
              ...
              l = !!(i && !k && !0 === this.options.crossfade && !this.path.some(fg));
            ((this.animationProgress = 0),
              (this.mixTargetDelta = (b) => {
                ...
                if (
                  ...
                  (dQ(
                    ...
                    ff(n.y, o.y, p.y, q),
                    c &&
                      ((j = this.relativeTarget), (m = c), eO(j.x, m.x) && eO(j.y, m.y)) &&
                      (this.isProjectionDirty = !1),
                    c || (c = W()),
                    eF(c, this.relativeTarget));
                }
                (i &&
                  ((this.animationValues = f),
                  (function (a, b, c, d, e, f) {
                    e
                      ? ((a.opacity = bN(0, c.opacity ?? 1, eB(d))),
                        (a.opacityExit = bN(b.opacity ?? 1, 0, eC(d))))
                    ...
                    for (let e = 0; e < ex; e++) {
                      ...
                      (void 0 !== g || void 0 !== h) &&
                        ...
                        h || (h = 0),
                        0 === g || 0 === h || ez(g) === ez(h)
                          ? ((a[f] = Math.max(bN(ey(g), ey(h), d), 0)),
                            (w.test(h) || w.test(g)) && (a[f] += "%"))
                          : (a[f] = h));
                    }
          ...
          startAnimation(a) {
            (this.notifyListeners("animationStart"),
              ...
              this.pendingAnimation &&
                (aE(this.pendingAnimation), (this.pendingAnimation = void 0)),
              (this.pendingAnimation = aD.update(() => {
                ((eq.hasAnimatedSinceResize = !0),
                  a3.layout++,
                  this.motionValue || (this.motionValue = bh(0)),
                  this.motionValue.jump(0, !1),
                  (this.currentAnimation = (function (a, b, c) {
                    let d = X(a) ? a : bh(a);
                    return (d.start(dw("", d, b, c)), d.animation);
                    ...
                    onComplete: () => {
                      (a3.layout--, a.onComplete && a.onComplete(), this.completeAnimation());
                    },
                  })),
          ...
          applyTransformsToTarget() {
            ...
            if (b && c && d) {
              if (
                ...
                this.layout &&
                d &&
                fl(this.options.animationType, this.layout.layoutBox, d.layoutBox)
              ) {
                c = this.target || W();
                let b = dL(this.layout.layoutBox.x);
                ((c.x.min = a.target.x.min), (c.x.max = c.x.min + b));
                let d = dL(this.layout.layoutBox.y);
                ((c.y.min = a.target.y.min), (c.y.max = c.y.min + d));
              }
              (eF(b, c),
                b2(b, e),
                dN(this.projectionDeltaWithTransform, this.layoutCorrected, b, e));
            }
          }
          registerSharedNode(a, b) {
            (this.sharedNodes.has(a) || this.sharedNodes.set(a, new eT()),
          ...
          applyProjectionStyles(a, b) {
            ...
            if (this.needsReset) {
              ((this.needsReset = !1),
                (a.visibility = ""),
                (a.opacity = ""),
                (a.pointerEvents = cj(b?.pointerEvents) || ""),
            ...
            this.options.layoutId &&
              (a.pointerEvents = d === this ? cj(b?.pointerEvents) || "" : "none");
          }
          clearSnapshot() {
      ...
      function e0(a) {
        ...
        if (a.isLead() && a.layout && b && a.hasListeners("didUpdate")) {
          ...
          if ("size" === e)
            ...
            let a = "x" === e ? "y" : "x";
            eE(f ? b.measuredBox[a] : b.layoutBox[a], c[a]);
          } else
            fl(e, b.layoutBox, c) &&
              dK((d) => {
          ...
          dN(g, c, b.layoutBox);
          let h = U();
          f ? dN(h, a.applyTransform(d, !0), b.measuredBox) : dN(h, c, b.layoutBox);
          let i = !eN(g),
            j = !1;
          if (!a.resumeFrom) {
            ...
            if (d && !d.resumeFrom) {
              ...
              if (e && f) {
                let g = a.options.layoutAnchor || void 0,
                  h = W();
                dQ(h, b.layoutBox, e.layoutBox, g);
                let i = W();
                (dQ(i, c, f.layoutBox, g),
                  eQ(h, i) || (j = !0),
      ...
      let fh = { duration: 0.45, ease: [0.4, 0, 0.1, 1] },
        fi = (a) =>
          "undefined" != typeof navigator &&
          navigator.userAgent &&
          navigator.userAgent.toLowerCase().includes(a),
        fj = fi("applewebkit/") && !fi("chrome/") ? Math.round : ay;
      function fk(a) {
        ((a.min = fj(a.min)), (a.max = fj(a.max)));
      }
      function fl(a, b, c) {
        return "position" === a || ("preserve-aspect" === a && !(0.2 >= Math.abs(eR(b) - eR(c))));
      }
      function fm(a) {
        return a !== a.root && a.scroll?.wasRoot;
      }
      let fn = e$({
          attachResizeListener: (a, b) => dT(a, "resize", b),
          measureScroll: () => ({
        ...
        fp = e$({
          ...
          defaultParent: () => {
            if (!fo.current) {
              let a = new fn({});
              (a.mount(window), a.setOptions({ layoutScroll: !0 }), (fo.current = a));
            }
            return fo.current;
          },
          resetTransform: (a, b) => {
      ...
      class fs extends ct {
        mount() {
          ...
          a &&
              ...
              return (
                d.forEach((a) => {
                  ...
                  (a.addEventListener(
                    "pointerenter",
                    (d) => {
                      if ("touch" === d.pointerType || dJ.x || dJ.y) return;
                      f = !1;
                      let g = b(a, d);
            ...
            })(a, (a, b) => (fr(this.node, b, "Start"), (a) => fr(this.node, a, "End"))));
        }
        unmount() {}
      }
      class ft extends ct {
      ...
      var fu = c(93238);
      let fv = (a, b) => !!b && (a === b || fv(a, b.parentElement)),
        fw = new WeakSet();
      function fx(a) {
        return (b) => {
          "Enter" === b.key && a(b);
          ...
          this.unmount = (function (a, b, c = {}) {
            let [d, e, f] = fq(a, c),
              g = (a) => {
                ...
                if (!fz(a) || fA.has(a)) return;
                (fw.add(d), c.stopPropagation && fA.add(a));
                let f = b(d, a),
                  g = (a, b) => {
                    (window.removeEventListener("pointerup", h),
                      window.removeEventListener("pointercancel", i),
                      fw.has(d) && fw.delete(d),
                      fz(a) && "function" == typeof f && f(a, { success: b }));
                  },
                  h = (a) => {
                    g(a, d === window || d === document || c.useGlobalTarget || fv(d, a.target));
                  },
                  i = (a) => {
                    g(a, !1);
                  };
                    ...
                    ((a, b) => {
                      ...
                      let d = fx(() => {
                        ...
                        (c.addEventListener("keyup", a, b),
                          c.addEventListener("blur", () => fy(c, "cancel"), b));
                      });
            ...
            a,
            (a, b) => (
              fB(this.node, b, "Start"),
              (a, { success: b }) => fB(this.node, a, b ? "End" : "Cancel")
            ),
        ...
        startObserver() {
          ...
          let { viewport: a = {} } = this.node.getProps(),
            ...
            f = {
              ...
              rootMargin: c,
              threshold: "number" == typeof d ? d : fH[d],
            },
            g = (a) => {
          ...
          this.stopObserver = (function (a, b, c) {
            let d = (function ({ root: a, ...b }) {
              ...
              let d = fE.get(c),
                e = JSON.stringify(b);
              return (d[e] || (d[e] = new IntersectionObserver(fG, { root: a, ...b })), d[e]);
            })(b);
            return (
              fD.set(a, c),
              d.observe(a),
              () => {
                (fD.delete(a), d.unobserve(a));
              }
            );
      ...
      let fJ = (function (a, b) {
        if ("undefined" == typeof Proxy) return cs;
        let c = new Map(),
          d = (c, d) => cs(c, d, a, b);
        return new Proxy((a, b) => d(a, b), {
          get: (e, f) =>
            "create" === f ? d : (c.has(f) || c.set(f, cs(f, void 0, a, b)), c.get(f)),
        });
      })(
        {
          animation: { Feature: dG },
          exit: { Feature: dI },
          inView: { Feature: fI },
          tap: { Feature: fC },
          focus: { Feature: ft },
          hover: { Feature: fs },
          pan: { Feature: ep },
          drag: { Feature: en, ProjectionNode: fp, MeasureLayout: ev },
          layout: { ProjectionNode: fp, MeasureLayout: ev },
        },
        (a, b) =>
          (b.isSVG ?? b7(a)) ? new bS(b) : new b4(b, { allowProjection: a !== b5.Fragment }),
      );
    },
    21664: (a, b, c) => {
      c.d(b, { t: () => d });
      let d = (0, c(38301).createContext)(null);
    },
    22577: (a, b, c) => {
      c.d(b, { Q: () => d });
      let d = (0, c(38301).createContext)({
