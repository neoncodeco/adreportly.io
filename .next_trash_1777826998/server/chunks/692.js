  ...
  (exports.modules = {
    3421: (a, b, c) => {
      ...
      async function g(a, b, c, g) {
        if ((0, d.isNodeNextResponse)(b)) {
            ...
            h.forEach((a, c) => {
              if ("x-middleware-set-cookie" !== c.toLowerCase())
                if ("set-cookie" === c.toLowerCase())
                  for (let d of (0, f.splitCookiesString)(a)) b.appendHeader(c, d);
                else {
          ...
          c.body && "HEAD" !== a.method ? await (0, e.pipeToNodeResponse)(c.body, i, g) : i.end();
        }
      }
    },
    10641: (a, b, c) => {
    ...
    97324: (a, b, c) => {
      ...
      function n(a) {
        ...
        if (!e)
          throw Object.defineProperty(
            Error(`Route ${c.route} used ${b} outside of a Server Component. This is not allowed.`),
            "__NEXT_ERROR_CODE",
