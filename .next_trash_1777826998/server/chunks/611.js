  ...
  (exports.modules = {
      ...
      function g(a) {
              ...
              : (0, d.ensureLeadingSlash)(a);
        {
          let { posix: a } = c(33873),
            d = a.normalize(b);
          if (d !== b)
            throw new f.NormalizeError("Requested and resolved page mismatch: " + b + " " + d);
        }
        return b;
      }
    },
    ...
    63135: (a, b) => {
      ...
      function e(a, b) {
        ...
        return f + d((a = Number((a / Math.pow(1e3, g)).toPrecision(3))), b.locale) + " " + c[g];
      }
    },
    63885: (a, b, c) => {
      "use strict";
      ...
      function u(a, b) {
        let { scriptLoader: c, disableOptimizedLoading: f, crossOrigin: g } = a,
          h = (function (a, b) {
            ...
            if (!h) return null;
            try {
              let { partytownSnippet: a } = require("@builder.io/partytown/integration"),
              ...
              f &&
                (0, d.jsxs)(d.Fragment, {
                  children: [
                    ...
                    !D &&
                      (0, d.jsx)("link", { rel: "canonical", href: h + c(77782).cleanAmpPath(j) }),
                    (0, d.jsx)("link", {
                      rel: "preload",
                      as: "script",
...
See more info here: https://nextjs.org/docs/messages/large-page-data`)),
    ...
    75201: (a) => {
      "use strict";
      a.exports = ["chrome 64", "edge 79", "firefox 67", "opera 51", "safari 12"];
    },
    76915: (a, b) => {
      "use strict";
      (Object.defineProperty(b, "__esModule", { value: !0 }),
    ...
    80092: (a, b, c) => {
      "use strict";
      a.exports = c(63885).vendored.contexts.HtmlContext;
    },
    82199: (a, b, c) => {
      "use strict";
      (Object.defineProperty(b, "__esModule", { value: !0 }),
    ...
    88893: (a, b, c) => {
      ...
      function f(a, b) {
        let c = (0, d.denormalizePagePath)((0, e.normalizePagePath)(b)),
          f = a.pages[c];
        return (
          f || (console.warn(`Could not find files for ${c} in .next/build-manifest.json`), [])
        );
      }
    },
    92815: (a, b) => {
        ...
        _insert(a, b, d) {
          ...
          if (e.startsWith("[") && e.endsWith("]")) {
            let c = e.slice(1, -1),
              g = !1;
            if (
              (c.startsWith("[") && c.endsWith("]") && ((c = c.slice(1, -1)), (g = !0)),
              c.startsWith("…"))
            )
              throw Object.defineProperty(
                Error(
                  "Detected a three-dot character ('…') at ('" + c + "'). Did you mean ('...')?",
                ),
                "__NEXT_ERROR_CODE",
            ...
            if (
              ...
              throw Object.defineProperty(
                Error("Segment names may not start or end with extra brackets ('" + c + "')."),
                "__NEXT_ERROR_CODE",
                { value: "E421", enumerable: !1, configurable: !0 },
              );
            if (c.startsWith("."))
              throw Object.defineProperty(
                Error("Segment names may not start with erroneous periods ('" + c + "')."),
                "__NEXT_ERROR_CODE",
            ...
            if (d)
              if (g) {
                ...
                (f(this.optionalRestSlugName, c), (this.optionalRestSlugName = c), (e = "[[...]]"));
              } else {
                if (null != this.optionalRestSlugName)
                  throw Object.defineProperty(
                    Error(
                ...
                (f(this.restSlugName, c), (this.restSlugName = c), (e = "[...]"));
              }
            else {
              if (g)
                throw Object.defineProperty(
