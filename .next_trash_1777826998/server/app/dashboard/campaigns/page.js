    ...
    (a.modules = {
      ...
      23861: (a, b, c) => {
                    ...
                    children: [
                      "campaigns",
                      {
                        children: [
                          ...
                          {
                            page: [
                              () => Promise.resolve().then(c.bind(c, 75508)),
                              "/media/iqbalxrr/Project Disk/Agency Work/ad_reportly/src/app/dashboard/campaigns/page.tsx",
                            ],
                          },
                        ],
                      },
        ...
        async function L(a, b, d) {
          var C;
          let G = "/dashboard/campaigns/page";
          "/index" === G && (G = "/");
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
      ...
      67790: (a, b, c) => {
        "use strict";
        c.d(b, { CampaignsPage: () => d });
        let d = (0, c(97954).registerClientReference)(
          function () {
            throw Error(
              "Attempted to call CampaignsPage() from the server but CampaignsPage is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
            );
          },
      ...
      68548: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 84249));
      },
      75508: (a, b, c) => {
        "use strict";
        ...
        var d = c(75338),
          e = c(67790);
        function f() {
          return (0, d.jsx)(e.CampaignsPage, {});
        }
      },
      84249: (a, b, c) => {
        "use strict";
        c.d(b, { CampaignsPage: () => s });
        var d = c(21124),
          e = c(3991),
          f = c.n(e),
          g = c(38301),
          ...
          j = c(88285),
          k = c(14959);
        let l = (0, k.A)("sliders-horizontal", [
        ...
        function s() {
          let [a, b] = (0, g.useState)([]),
            [c, e] = (0, g.useState)("৳"),
            [k, s] = (0, g.useState)(!0),
            [t, u] = (0, g.useState)(null),
            [v, w] = (0, g.useState)("");
          (0, g.useCallback)(async () => {
            (s(!0), u(null));
            try {
              let a = await fetch("/api/dashboard/overview", { credentials: "include" }),
                c = await a.json();
              if (!a.ok || !1 === c.success) {
                (u("string" == typeof c.error ? c.error : "Could not load campaigns"), b([]));
                return;
              }
              (e(c.currencySymbol ?? "৳"),
                b(c.campaigns?.length ? c.campaigns : (c.recentCampaigns ?? [])));
            } catch {
              (u("Network error"), b([]));
            } finally {
              s(!1);
          ...
          let x = (0, g.useMemo)(() => {
              ...
              return b ? a.filter((a) => a.name.toLowerCase().includes(b) || a.id.includes(b)) : a;
            }, [a, v]),
            y = x.filter((a) => "active" === a.status).length;
          return k
            ? (0, d.jsx)("div", {
                    ...
                    (0, d.jsxs)("div", {
                      ...
                      children: [
                        ...
                        (0, d.jsx)(o.$, {
                          ...
                          type: "button",
                          children: (0, d.jsx)(l, { className: "h-4 w-4" }),
                        }),
                      ],
                    }),
                    0 === x.length
                            ...
                            children: [
                                      ...
                                      (0, d.jsxs)("div", {
                                        ...
                                        children: [
                                          ...
                                          (0, d.jsxs)("span", {
                                            ...
                                            children: ["\xb7 ", a.accounts, " ad accounts"],
                                          }),
                                        ],
                                      }),
                                    ],
                                  ...
                                  (0, d.jsxs)("div", {
                                    children: [
                                      ...
                                      (0, d.jsx)("div", {
                                        ...
                                        children: a.roas > 0 ? `${a.roas.toFixed(2)}\xd7` : "—",
                                      }),
                                    ],
                                  }),
                                ],
                              ...
                              (0, d.jsx)(o.$, {
                                ...
                                children: (0, d.jsxs)(f(), {
                                  ...
                                  children: [
                                    (0, d.jsx)(n.A, { className: "mr-2 h-3.5 w-3.5" }),
                                    " Share",
                                  ],
                                }),
                              }),
                                ...
                                (0, d.jsxs)(
                                  "tr",
                                  {
                                    ...
                                    children: [
                                          ...
                                          children: [
                                            ...
                                            (0, d.jsxs)("div", {
                                              children: [
                                                ...
                                                (0, d.jsxs)("div", {
                                                  className: "text-xs text-muted-foreground",
                                                  children: [a.accounts, " ad accounts"],
                                                }),
                                              ],
                                            }),
                                          ],
                                      ...
                                      (0, d.jsxs)("td", {
                                        className: "py-4 pr-4 text-right tabular-nums",
                                        children: [a.ctr.toFixed(2), "%"],
                                      }),
                                      (0, d.jsxs)("td", {
                                        className: "py-4 pr-4 text-right tabular-nums",
                                        children: [c, a.cpc.toFixed(2)],
                                      }),
                                      (0, d.jsx)("td", {
                                        className:
                                          "py-4 pr-4 text-right font-semibold tabular-nums",
                                        children: a.roas > 0 ? `${a.roas.toFixed(2)}\xd7` : "—",
                                      }),
                                      (0, d.jsx)("td", {
                                        ...
                                        children: (0, d.jsx)(o.$, {
                                          ...
                                          children: (0, d.jsxs)(f(), {
                                            href: "/dashboard/reports",
                                            children: [
                                              (0, d.jsx)(n.A, { className: "mr-1.5 h-3.5 w-3.5" }),
                                              " Share",
                                            ],
                                          }),
                                        }),
      ...
      87108: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 67790));
      },
    }));
  var b = require("../../../webpack-runtime.js");
  b.C(a);
  var c = b.X(0, [331, 925, 20, 85, 872, 859, 303, 961], () => b((b.s = 23861)));
  module.exports = c;
})();
