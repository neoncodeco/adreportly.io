(() => {
  ...
  ((a.id = 105),
    ...
    (a.modules = {
      ...
      5115: (a, b, c) => {
        "use strict";
        c.d(b, { DashboardHome: () => d });
        let d = (0, c(97954).registerClientReference)(
          function () {
            throw Error(
              "Attempted to call DashboardHome() from the server but DashboardHome is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
            );
          },
      ...
      21302: (a, b, c) => {
        ...
        let B = [
            ...
            { key: "total", label: "Total Spend", icon: q.A, highlight: !1 },
            { key: "conversions", label: "Conversions", icon: s, highlight: !1 },
            { key: "roas", label: "Avg ROAS", icon: t, highlight: !1 },
            { key: "cpc", label: "Avg CPC", icon: u, highlight: !1 },
          ],
          C = {
            overview: {
        ...
        function D() {
          let [a, b] = (0, g.useState)(null),
            [c, e] = (0, g.useState)(!0),
            [p, q] = (0, g.useState)(null),
            r = (0, g.useCallback)(async () => {
              ...
              try {
                let a = await fetch("/api/dashboard/overview", { credentials: "include" }),
                  c = await a.json();
                if (!a.ok || !1 === c.success) {
                  (q("string" == typeof c.error ? c.error : "Could not load dashboard"), b(null));
                  return;
                }
                b(c);
              } catch {
                (q("Network error"), b(null));
              } finally {
                e(!1);
              }
            }, []),
            ...
            F = u[0]?.spend ?? 0,
            G = (0, g.useMemo)(() => {
              let a = E?.totalSpend ?? 0,
                b = E?.conversions ?? 0;
              return B.map((c) => {
                let d = "—";
                return (
                  "overview" === c.key || "total" === c.key
                    ? (d = `${s}${Math.round(a).toLocaleString()}`)
                    : "conversions" === c.key
                      ? (d = b > 0 ? b.toLocaleString() : "0")
                      : "roas" === c.key
                        ? (d = E?.avgRoas ?? "—")
                        : "cpc" === c.key && (d = E?.avgCpc ?? "—"),
                  { ...c, ...C[c.key], value: d, delta: null, up: !0 }
                );
              });
            }, [E, s]);
          return c && !a
                        ...
                        (0, d.jsxs)(
                          "div",
                          {
                            className: (0, A.cn)(
                              ...
                              a.highlight && "col-span-2 lg:col-span-1",
                            ),
                            children: [
                              (0, d.jsx)("div", {
                                className: (0, A.cn)(
                              ...
                              (0, d.jsxs)("div", {
                                ...
                                children: [
                                  (0, d.jsx)("span", {
                                    ...
                                    children: (0, d.jsx)(a.icon, { className: "h-4 w-4" }),
                                  }),
                                  a.delta
                                    ? (0, d.jsxs)("span", {
                                        className: (0, A.cn)(
                                        ...
                                        children: [
                                          a.up
                                            ? (0, d.jsx)(w.A, { className: "h-3 w-3" })
                                            : (0, d.jsx)(x, { className: "h-3 w-3" }),
                                          a.delta,
                                        ],
                                      })
                                    : null,
                            ...
                            (0, d.jsxs)("div", {
                              ...
                              children: [
                                ...
                                (0, d.jsxs)("button", {
                                  ...
                                  children: [
                                    "Last 30 Days ",
                                    (0, d.jsx)(y.A, { className: "h-3.5 w-3.5" }),
                                  ],
                                }),
                              ],
                            }),
                                                    ...
                                                    children: [
                                                      ...
                                                      (0, d.jsxs)("span", {
                                                        ...
                                                        children: [
                                                          s,
                                                          a.spend >= 1e3
                                                            ? `${(a.spend / 1e3).toFixed(1)}K`
                                                            : a.spend.toLocaleString(void 0, {
                        ...
                        (0, d.jsxs)("div", {
                          ...
                          children: [
                            ...
                            (0, d.jsxs)(f(), {
                              ...
                              children: [
                                "View all ",
                                (0, d.jsx)(z.A, { className: "h-3.5 w-3.5" }),
                              ],
                            }),
                          ],
                        }),
                              ...
                              children: [
                                (0, d.jsx)("thead", {
                                  children: (0, d.jsxs)("tr", {
                                    ...
                                    children: [
                                      (0, d.jsx)("th", { className: "pb-3 pr-4", children: "No" }),
                                      (0, d.jsx)("th", {
                                        className: "pb-3 pr-4",
      ...
      21874: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 21302));
      },
      26713: (a) => {
        "use strict";
      ...
      41236: (a, b, c) => {
        ...
        var d = c(75338),
          e = c(5115);
        function f() {
          return (0, d.jsx)(e.DashboardHome, {});
        }
      },
      46267: (a, b, c) => {
        "use strict";
      ...
      48345: (a, b, c) => {
        ...
        let H = {
                ...
                children: [
                  "dashboard",
                  {
                    children: [
                      ...
                      {
                        page: [
                          () => Promise.resolve().then(c.bind(c, 41236)),
                          "/media/iqbalxrr/Project Disk/Agency Work/ad_reportly/src/app/dashboard/page.tsx",
                        ],
                      },
                    ],
                  },
          ...
          I = ["/media/iqbalxrr/Project Disk/Agency Work/ad_reportly/src/app/dashboard/page.tsx"],
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
      ...
      58826: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 5115));
      },
      63033: (a) => {
        "use strict";
  ...
  b.C(a);
  var c = b.X(0, [331, 925, 20, 85, 872, 859, 944, 598, 303, 961], () => b((b.s = 48345)));
  module.exports = c;
})();
