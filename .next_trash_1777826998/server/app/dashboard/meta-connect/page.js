(() => {
  ...
  ((a.id = 272),
    ...
    (a.modules = {
      ...
      19664: (a, b, c) => {
        "use strict";
        c.d(b, { MetaConnectPage: () => d });
        let d = (0, c(97954).registerClientReference)(
          function () {
            throw Error(
              "Attempted to call MetaConnectPage() from the server but MetaConnectPage is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
            );
          },
      ...
      48812: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 19664));
      },
      51028: (a, b, c) => {
        "use strict";
        c.d(b, { MetaConnectPage: () => I });
        var d = c(21124),
          e = c(38301),
          f = c(42378),
          g = c(4085),
        ...
        var m = c(35284),
          ...
          z = e.forwardRef((a, b) => {
            let {
              ...
              v = (0, o.s)(b, (a) => s(a)),
              w = e.useRef(!1),
              y = !r || m || !!r.closest("form"),
              [z, A] = (0, q.i)({ prop: g, defaultProp: h ?? !1, onChange: l, caller: u });
            return (0, d.jsxs)(x, {
              scope: c,
              checked: z,
              disabled: j,
              children: [
                (0, d.jsx)(t.sG.button, {
                  ...
                  ...p,
                  ref: v,
                  onClick: (0, n.mK)(a.onClick, (a) => {
                    (A((a) => !a),
                      y &&
                        ((w.current = a.isPropagationStopped()), w.current || a.stopPropagation()));
                  }),
                }),
                y &&
                  (0, d.jsx)(C, {
        ...
        var A = "SwitchThumb",
          B = e.forwardRef((a, b) => {
            let { __scopeSwitch: c, ...e } = a,
              f = y(A, c);
            return (0, d.jsx)(t.sG.span, {
              "data-state": D(f.checked),
        ...
        B.displayName = A;
        var C = e.forwardRef(
          ({ __scopeSwitch: a, control: b, checked: c, bubbles: f = !0, ...g }, h) => {
            let i = e.useRef(null),
              j = (0, o.s)(i, h),
              k = (0, r.Z)(c),
              l = (0, s.X)(b);
            return (
              e.useEffect(() => {
                ...
                if (k !== c && b) {
                  let d = new Event("click", { bubbles: f });
        ...
        C.displayName = "SwitchBubbleInput";
        var E = c(44943);
        let F = e.forwardRef(({ className: a, ...b }, c) =>
          (0, d.jsx)(z, {
            className: (0, E.cn)(
        ...
        function H(a) {
          return "active" === a ? "bg-success/15 text-success" : "bg-muted text-muted-foreground";
        }
        function I() {
          (0, f.useSearchParams)();
          let [a, b] = (0, e.useState)([]),
            ...
            r = (0, e.useCallback)(async () => {
              (j(!0), o(null));
              try {
                let a = await fetch("/api/ad-accounts", { credentials: "include" }),
                  c = await a.json();
                if (!a.ok || !1 === c.success) {
                  (o("string" == typeof c.error ? c.error : "Could not load ad accounts"), b([]));
                  return;
                }
                b(c.adAccounts ?? []);
              } catch {
                ...
                (0, d.jsxs)("div", {
                  ...
                  children: [
                    ...
                    (0, d.jsx)("div", {
                      ...
                      children: (0, d.jsx)(h.A, { className: "h-8 w-8 sm:h-10 sm:w-10" }),
                    }),
                    (0, d.jsx)("h3", {
                      className: "relative mt-5 text-lg font-bold sm:text-xl",
                      children: n ? "Could not load accounts" : "No Ad Accounts Yet",
                    }),
                    (0, d.jsx)("p", {
                      className: "relative mx-auto mt-1.5 max-w-sm text-sm text-muted-foreground",
                      children:
                        n ?? "Connect your Facebook account to sync the ad accounts you manage.",
                    }),
                    (0, d.jsx)(m.$, {
                      className:
                                        ...
                                        (0, d.jsxs)("div", {
                                          ...
                                          children: [
                                            (0, d.jsx)("span", {
                                              ...
                                              children: (0, d.jsx)(h.A, { className: "h-5 w-5" }),
                                            }),
                                            (0, d.jsxs)("div", {
                                              ...
                                              children: [
                                                ...
                                                (0, d.jsxs)("div", {
                                                  ...
                                                  children: [
                                                    (0, d.jsx)("span", {
                                                      className: `rounded-full px-2 py-0.5 text-[10px] font-semibold uppercase ${H(b)}`,
                                                      children: b,
                                                    }),
                                                    (0, d.jsx)("span", {
                                                      className:
                                            ...
                                            children: [
                                              ...
                                              (0, d.jsx)("td", {
                                                ...
                                                children: (0, d.jsx)("span", {
                                                  className: `inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold uppercase ${H(b)}`,
                                                  children: b,
                                                }),
                                              }),
                                              (0, d.jsx)("td", {
                                              ...
                                              (0, d.jsx)("td", {
                                                ...
                                                children: (0, d.jsxs)("button", {
                                                  ...
                                                  onClick: () => void r(),
                                                  children: [
                                                    (0, d.jsx)(l, { className: "h-3.5 w-3.5" }),
                                                    " Refresh",
                                                  ],
                                                }),
                                              }),
      ...
      52305: (a, b, c) => {
        ...
        let j = (0, e.forwardRef)(
            (
              ...
              (0, e.createElement)(
                ...
                [...j.map(([a, b]) => (0, e.createElement)(a, b)), ...(Array.isArray(h) ? h : [h])],
              ),
          ),
          k = ((a, b) => {
            let c = (0, e.forwardRef)(({ className: c, ...d }, f) =>
              (0, e.createElement)(j, {
                ref: f,
                iconNode: b,
                className: g(
        ...
        function l() {
          return (0, d.jsx)(e.Suspense, {
            ...
            children: (0, d.jsx)(f.MetaConnectPage, {}),
          });
        }
      },
      63033: (a) => {
      ...
      72213: (a, b, c) => {
        ...
        let H = {
                    ...
                    children: [
                      "meta-connect",
                      {
                        children: [
                          ...
                          {
                            page: [
                              () => Promise.resolve().then(c.bind(c, 52305)),
                              "/media/iqbalxrr/Project Disk/Agency Work/ad_reportly/src/app/dashboard/meta-connect/page.tsx",
                            ],
                          },
                        ],
                      },
          ...
          K = new d.AppPageRouteModule({
            definition: {
              ...
              page: "/dashboard/meta-connect/page",
              pathname: "/dashboard/meta-connect",
              bundlePath: "",
              filename: "",
              appPaths: [],
            },
        ...
        async function L(a, b, d) {
          var C;
          let G = "/dashboard/meta-connect/page";
          "/index" === G && (G = "/");
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
      ...
      96012: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 51028));
      },
    }));
  var b = require("../../../webpack-runtime.js");
  b.C(a);
  var c = b.X(0, [331, 925, 20, 85, 872, 859, 303, 961], () => b((b.s = 72213)));
  module.exports = c;
})();
