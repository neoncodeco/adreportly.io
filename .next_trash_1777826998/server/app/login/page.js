    ...
    (a.modules = {
      ...
      15109: (a, b, c) => {
        ...
        let d = (0, c(97954).registerClientReference)(
          function () {
            throw Error(
              "Attempted to call the default export of \"/media/iqbalxrr/Project Disk/Agency Work/ad_reportly/src/app/login/page.tsx\" from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
            );
          },
        ...
        function r() {
          let { signIn: a, user: b } = (0, m.A)(),
            ...
            [e, r] = (0, h.useState)(!1),
            {
              ...
              handleSubmit: t,
              formState: { errors: u },
            } = (0, i.mN)({ defaultValues: { email: "", password: "" } }),
            v = async (b) => {
              r(!0);
              let { error: d } = await a(b.email.trim(), b.password);
              (r(!1),
                d
                  ? q.oR.error(d.message || "Invalid credentials")
                  : (q.oR.success("Welcome back!"), c.replace("/dashboard")));
            };
          return (0, d.jsx)("div", {
            ...
            children: (0, d.jsxs)("div", {
              ...
              children: [
                (0, d.jsxs)(f(), {
                  ...
                  children: [
                    (0, d.jsx)("span", {
                      ...
                      children: (0, d.jsx)(j.A, { className: "h-4 w-4" }),
                    }),
                    (0, d.jsx)("span", {
                ...
                (0, d.jsxs)("div", {
                  ...
                  children: [
                    (0, d.jsx)("h1", { className: "text-2xl font-bold", children: "Welcome back" }),
                    (0, d.jsx)("p", {
                    ...
                    (0, d.jsxs)("form", {
                      ...
                      children: [
                        (0, d.jsxs)("div", {
                          ...
                          children: [
                            (0, d.jsx)(p.J, { htmlFor: "email", children: "Email" }),
                            (0, d.jsx)(o.p, {
                              className: "rounded",
                              id: "email",
                              type: "email",
                        ...
                        (0, d.jsxs)("div", {
                          ...
                          children: [
                            (0, d.jsxs)("div", {
                              ...
                              children: [
                                (0, d.jsx)(p.J, { htmlFor: "password", children: "Password" }),
                                (0, d.jsx)(f(), {
                        ...
                        (0, d.jsx)(n.$, {
                          ...
                          children: e
                            ? (0, d.jsx)(k.A, { className: "h-4 w-4 animate-spin" })
                            : "Sign in",
                        }),
                      ],
                    }),
                    ...
                    (0, d.jsx)(n.$, {
                      ...
                      children: (0, d.jsxs)("a", {
                        ...
                        children: [
                          (0, d.jsx)(l.A, { className: "mr-2 h-4 w-4 shrink-0 text-[#1877F2]" }),
      ...
      40619: (a, b, c) => {
        ...
        let H = {
          ...
          I = ["/media/iqbalxrr/Project Disk/Agency Work/ad_reportly/src/app/login/page.tsx"],
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
  ...
  b.C(a);
  var c = b.X(0, [331, 925, 20, 853, 98], () => b((b.s = 40619)));
  module.exports = c;
})();
