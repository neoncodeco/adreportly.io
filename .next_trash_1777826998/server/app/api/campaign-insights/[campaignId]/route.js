(() => {
    ...
    (a.modules = {
      ...
      85031: (a, b, c) => {
        ...
        async function y(a, b) {
          ...
          let { campaignId: d } = await b.params;
          if (!d)
            return u.NextResponse.json(
              { success: !1, error: "campaignId required" },
              { status: 400 },
            );
          let e = await (0, w.yD)(c);
          if (!e)
            return u.NextResponse.json(
              { success: !1, error: "Meta not connected" },
              { status: 400 },
            );
          let f = a.nextUrl,
            g = f.searchParams.get("date_preset") ?? "last_30d",
            h = f.searchParams.get("time_increment") ?? void 0;
          try {
            let a = await (0, x.kr)(e, decodeURIComponent(d), {
              datePreset: g,
              timeIncrement: h ?? void 0,
            });
            return u.NextResponse.json({ success: !0, insights: a.data ?? [] });
          } catch (b) {
        ...
        let z = new e.AppRouteRouteModule({
            definition: {
              ...
              page: "/api/campaign-insights/[campaignId]/route",
              pathname: "/api/campaign-insights/[campaignId]",
              filename: "route",
              bundlePath: "app/api/campaign-insights/[campaignId]/route",
            },
            distDir: ".next",
            relativeProjectDir: "",
            resolvedPagePath:
              "/media/iqbalxrr/Project Disk/Agency Work/ad_reportly/src/app/api/campaign-insights/[campaignId]/route.ts",
            nextConfigOutput: "",
            userland: d,
          }),
        ...
        async function E(a, b, c) {
          var d;
          let e = "/api/campaign-insights/[campaignId]/route";
          "/index" === e && (e = "/");
  ...
  b.C(a);
  var c = b.X(0, [331, 692, 28, 271, 840], () => b((b.s = 85031)));
  module.exports = c;
})();
