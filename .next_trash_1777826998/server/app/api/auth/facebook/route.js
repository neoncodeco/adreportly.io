(() => {
    ...
    (a.modules = {
      ...
      85670: (a, b, c) => {
        ...
        var e = c(95736),
          ...
          v = c(60524);
        async function w(a) {
          let b = process.env.FACEBOOK_APP_ID,
            c =
            ...
            d =
              ...
              `${c.replace(/\/$/, "")}/api/auth/facebook/callback`;
          if (!b)
          ...
          let e = crypto.randomUUID(),
            f = new URL("https://www.facebook.com/v18.0/dialog/oauth");
          (f.searchParams.set("client_id", b),
            f.searchParams.set("redirect_uri", d),
            f.searchParams.set("state", e),
            f.searchParams.set("scope", "ads_management,business_management"));
          let g = await (0, v.j2)(),
            h = u.NextResponse.redirect(f.toString());
          return (
            h.cookies.set("fb_oauth_state", e, {
              httpOnly: !0,
              secure: !0,
              path: "/",
              maxAge: 600,
            ...
            g?.user?.id
              ? h.cookies.set("fb_oauth_app_user", g.user.id, {
                  httpOnly: !0,
                  secure: !0,
                  sameSite: "lax",
                  path: "/",
              ...
              : h.cookies.set("fb_oauth_app_user", "", {
                  httpOnly: !0,
                  secure: !0,
                  path: "/",
                  maxAge: 0,
        ...
        let x = new e.AppRouteRouteModule({
            definition: {
              ...
              page: "/api/auth/facebook/route",
              pathname: "/api/auth/facebook",
              filename: "route",
              bundlePath: "app/api/auth/facebook/route",
            },
            distDir: ".next",
            relativeProjectDir: "",
            resolvedPagePath:
              "/media/iqbalxrr/Project Disk/Agency Work/ad_reportly/src/app/api/auth/facebook/route.ts",
            nextConfigOutput: "",
            userland: d,
          }),
          { workAsyncStorage: y, workUnitAsyncStorage: z, serverHooks: A } = x;
        function B() {
          return (0, g.patchFetch)({ workAsyncStorage: y, workUnitAsyncStorage: z });
        }
        async function C(a, b, c) {
          var d;
          let e = "/api/auth/facebook/route";
          "/index" === e && (e = "/");
          let g = await x.prepare(a, b, { srcPage: e, multiZoneDraftMode: !1 });
          if (!g)
            return (
              (b.statusCode = 400),
              b.end("Bad Request"),
          ...
          let H = !0 === x.isDev || !F,
            ...
            M = {
              ...
              renderOpts: {
                ...
                onInstrumentationRequestError: (b, c, d) => x.onRequestError(a, b, d, A),
              },
  ...
  b.C(a);
  var c = b.X(0, [331, 692, 28, 271], () => b((b.s = 85670)));
  module.exports = c;
})();
