(() => {
    ...
    (a.modules = {
      ...
      40007: (a, b, c) => {
        ...
        var e = c(95736),
          ...
          s = c(86439),
          t = c(51356);
        let { GET: u, POST: v } = c(60524).Y9,
          w = new e.AppRouteRouteModule({
            definition: {
            ...
            relativeProjectDir: "",
            resolvedPagePath:
              "/media/iqbalxrr/Project Disk/Agency Work/ad_reportly/src/app/api/auth/[...nextauth]/route.ts",
            nextConfigOutput: "",
            userland: d,
          }),
          { workAsyncStorage: x, workUnitAsyncStorage: y, serverHooks: z } = w;
        function A() {
          return (0, g.patchFetch)({ workAsyncStorage: x, workUnitAsyncStorage: y });
        }
        async function B(a, b, c) {
          var d;
          let e = "/api/auth/[...nextauth]/route";
          "/index" === e && (e = "/");
          let g = await w.prepare(a, b, { srcPage: e, multiZoneDraftMode: !1 });
          if (!g)
            return (
              (b.statusCode = 400),
              b.end("Bad Request"),
          ...
          let H = !0 === w.isDev || !F,
            ...
            M = {
              ...
              renderOpts: {
                experimental: {
                  cacheComponents: !!x.experimental.cacheComponents,
                ...
                cacheLifeProfiles: null == (d = x.experimental) ? void 0 : d.cacheLife,
                isRevalidate: I,
                ...
                onInstrumentationRequestError: (b, c, d) => w.onRequestError(a, b, d, A),
              },
  ...
  b.C(a);
  var c = b.X(0, [331, 692, 28, 271], () => b((b.s = 40007)));
  module.exports = c;
})();
