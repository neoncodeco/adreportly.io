(() => {
    ...
    (a.modules = {
      ...
      86140: (a, b, c) => {
        ...
        var e = c(95736),
          ...
          x = c(72977),
          y = c(77492);
        let z = w.Ik({ token: w.Yj().min(10), password: w.Yj().min(8).max(72) });
        async function A(a) {
          let b;
          try {
            b = await a.json();
          ...
          let c = z.safeParse(b);
          if (!c.success) return u.NextResponse.json({ error: "Invalid request" }, { status: 400 });
          let { token: d, password: e } = c.data;
          try {
            await (0, x.I)();
          } catch (b) {
          ...
          let f = await y.F.findOne({
            resetPasswordToken: d,
            resetPasswordExpires: { $gt: new Date() },
          });
          if (!f)
            return u.NextResponse.json({ error: "Invalid or expired reset link" }, { status: 400 });
          let g = await v.Ay.hash(e, 12);
          return (
            await y.F.updateOne(
              { _id: f._id },
              {
        ...
        let B = new e.AppRouteRouteModule({
            definition: {
              ...
              page: "/api/auth/reset-password/route",
              pathname: "/api/auth/reset-password",
              filename: "route",
              bundlePath: "app/api/auth/reset-password/route",
            },
            distDir: ".next",
            relativeProjectDir: "",
            resolvedPagePath:
              "/media/iqbalxrr/Project Disk/Agency Work/ad_reportly/src/app/api/auth/reset-password/route.ts",
            nextConfigOutput: "",
            userland: d,
          }),
        ...
        async function G(a, b, c) {
          var d;
          let e = "/api/auth/reset-password/route";
          "/index" === e && (e = "/");
            ...
            let d = async (c) =>
              ...
              g = async (g) => {
                ...
                let k = async ({ previousCacheEntry: f }) => {
                    try {
                      if (!(0, h.getRequestMeta)(a, "minimalMode") && A && C && !f)
                        return (
                          (b.statusCode = 404),
  ...
  b.C(a);
  var c = b.X(0, [331, 692, 28, 711], () => b((b.s = 86140)));
  module.exports = c;
})();
