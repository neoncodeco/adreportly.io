(() => {
    ...
    (a.modules = {
      ...
      12849: (a, b, c) => {
        ...
        async function y(a, b) {
          let { token: c } = await b.params,
            d = await (0, v.Y7)(c);
          if (!d || d.expiresAt.getTime() < Date.now())
            return u.NextResponse.json(
              { success: !1, error: "Invalid or expired link" },
              { status: 404 },
            );
          let e = await (0, w.yD)(d.agencyId);
          if (!e)
            return u.NextResponse.json({
              success: !0,
              campaign: { id: d.campaignId, name: "Campaign", objective: "", status: "" },
              insights: [],
              clientEmail: d.clientEmail,
              demo: !0,
            });
          try {
            let a = await (0, x.NA)(e, d.campaignId),
              b = await (0, x.kr)(e, d.campaignId, { datePreset: "last_30d", timeIncrement: "1" });
            return (
              b.data?.length || (b = await (0, x.kr)(e, d.campaignId, { datePreset: "last_30d" })),
              u.NextResponse.json({
                success: !0,
                campaign: {
                  id: a.id,
                  name: a.name ?? d.campaignId,
            ...
            let a = b instanceof Error ? b.message : "Upstream error";
        ...
        let z = new e.AppRouteRouteModule({
            definition: {
              ...
              page: "/api/shared-campaign/[token]/route",
              pathname: "/api/shared-campaign/[token]",
              filename: "route",
              bundlePath: "app/api/shared-campaign/[token]/route",
            },
            distDir: ".next",
            relativeProjectDir: "",
            resolvedPagePath:
              "/media/iqbalxrr/Project Disk/Agency Work/ad_reportly/src/app/api/shared-campaign/[token]/route.ts",
            nextConfigOutput: "",
            userland: d,
          }),
        ...
        async function E(a, b, c) {
          var d;
          let e = "/api/shared-campaign/[token]/route";
          "/index" === e && (e = "/");
  ...
  b.C(a);
  var c = b.X(0, [331, 692], () => b((b.s = 12849)));
  module.exports = c;
})();
