(() => {
    ...
    (a.modules = {
      ...
      92067: (a, b, c) => {
        ...
        async function y(a, b) {
          ...
          let { accountId: d } = await b.params;
          if (!d)
            return u.NextResponse.json(
              { success: !1, error: "accountId required" },
              { status: 400 },
            );
          let e = await (0, w.yD)(c);
          if (!e) return u.NextResponse.json({ success: !0, campaigns: [] });
          try {
            let a = await (0, x.TM)(e, decodeURIComponent(d));
            return u.NextResponse.json({
              success: !0,
              campaigns: a.map((a) => ({
                id: a.id,
        ...
        let z = new e.AppRouteRouteModule({
            definition: {
              ...
              page: "/api/campaigns/[accountId]/route",
              pathname: "/api/campaigns/[accountId]",
              filename: "route",
              bundlePath: "app/api/campaigns/[accountId]/route",
            },
            distDir: ".next",
            relativeProjectDir: "",
            resolvedPagePath:
              "/media/iqbalxrr/Project Disk/Agency Work/ad_reportly/src/app/api/campaigns/[accountId]/route.ts",
            nextConfigOutput: "",
            userland: d,
          }),
        ...
        async function E(a, b, c) {
          var d;
          let e = "/api/campaigns/[accountId]/route";
          "/index" === e && (e = "/");
  ...
  b.C(a);
  var c = b.X(0, [331, 692, 28, 271, 840], () => b((b.s = 92067)));
  module.exports = c;
})();
