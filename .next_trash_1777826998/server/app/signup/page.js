    ...
    (a.modules = {
        ...
        function r() {
          let { signUp: a, user: b } = (0, m.A)(),
            ...
            v = async (b) => {
              ...
              (r(!1),
                d
                  ? q.oR.error(d.message || "Sign up failed")
                  : (q.oR.success("Account created — welcome aboard!"), c.replace("/dashboard")));
            };
          return (0, d.jsx)("div", {
                        ...
                        (0, d.jsxs)("div", {
                          ...
                          children: [
                            (0, d.jsxs)("div", {
                              ...
                              children: [
                                (0, d.jsx)(p.J, { htmlFor: "full_name", children: "Your name" }),
                                (0, d.jsx)(o.p, {
                                  className: "rounded",
                                  id: "full_name",
                            ...
                            (0, d.jsxs)("div", {
                              className: "space-y-1.5",
                              children: [
                                (0, d.jsx)(p.J, { htmlFor: "organization", children: "Agency" }),
                                (0, d.jsx)(o.p, {
                                  className: "rounded",
                                  id: "organization",
                                ...
                                u.organization &&
                                  (0, d.jsx)("p", {
                                    className: "text-xs text-destructive",
                                    children: u.organization.message,
                                  }),
                              ],
                            }),
                          ],
      ...
      44071: (a, b, c) => {
        ...
        let H = {
                ...
                children: [
                  "signup",
                  {
                    children: [
                      ...
                      {
                        page: [
                          () => Promise.resolve().then(c.bind(c, 90566)),
          ...
          I = ["/media/iqbalxrr/Project Disk/Agency Work/ad_reportly/src/app/signup/page.tsx"],
...
see more here https://nextjs.org/docs/messages/app-static-to-dynamic-error`),
      ...
      90566: (a, b, c) => {
        ...
        let d = (0, c(97954).registerClientReference)(
          function () {
            throw Error(
              "Attempted to call the default export of \"/media/iqbalxrr/Project Disk/Agency Work/ad_reportly/src/app/signup/page.tsx\" from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
            );
          },
          "/media/iqbalxrr/Project Disk/Agency Work/ad_reportly/src/app/signup/page.tsx",
          "default",
      ...
      93060: (a, b, c) => {
        Promise.resolve().then(c.bind(c, 13092));
      },
    }));
  var b = require("../../webpack-runtime.js");
  b.C(a);
  var c = b.X(0, [331, 925, 20, 853, 98], () => b((b.s = 44071)));
  module.exports = c;
})();
