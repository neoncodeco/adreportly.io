(() => {
  ...
  ((c.m = a),
    ...
    (() => {
      var a,
        b = Object.getPrototypeOf ? (a) => Object.getPrototypeOf(a) : (a) => a.__proto__;
      c.t = function (d, e) {
        if (
          (1 & e && (d = this(d)),
          8 & e ||
            ("object" == typeof d &&
              d &&
              ((4 & e && d.__esModule) || (16 & e && "function" == typeof d.then))))
        )
          return d;
        ...
        var g = {};
        a = a || [null, b({}), b([]), b(b)];
        for (var h = 2 & e && d; "object" == typeof h && !~a.indexOf(h); h = b(h))
    ...
    (c.d = (a, b) => {
      for (var d in b)
        c.o(b, d) && !c.o(a, d) && Object.defineProperty(a, d, { enumerable: !0, get: b[d] });
    }),
    (c.f = {}),
    (c.e = (a) => Promise.all(Object.keys(c.f).reduce((b, d) => (c.f[d](a, b), b), []))),
    (c.u = (a) => "" + a + ".js"),
