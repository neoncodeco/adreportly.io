(() => {
  ...
  ((a.id = 731),
    ...
    (a.modules = {
      ...
      1523: (a, b, c) => {
        "use strict";
        a.exports = c(63885).vendored.contexts.HeadManagerContext;
      },
      3147: (a, b) => {
        "use strict";
        function c(a) {
      ...
      12289: (a, b, c) => {
        ...
        let A = ({
          ...
          async function (E, F, G) {
            ...
            let J = a;
            "/index" === J && (J = "/");
            let K = await z.prepare(E, F, { srcPage: J, multiZoneDraftMode: !1 });
            if (!K) {
              ((F.statusCode = 400),
                F.end("Bad Request"),
            ...
            let {
              ...
              ae =
                null == U || null == (I = U.config) || null == (H = I.experimental)
                  ? void 0
            ...
            if (
              (z.isDev ||
                ...
                !ag ||
                ((ak = `${$ ? `/${$}` : ""}${("/" === J || "/" === ad) && $ ? "" : ad}${aj ? ".amp" : ""}`),
                (an || ao || ap) && (ak = `${$ ? `/${$}` : ""}${J}${aj ? ".amp" : ""}`),
                (ak = "/index" === ak ? "/" : ak)),
              ah && !X)
            ) {
              let a = (0, y.removeTrailingSlash)($ ? (0, x.addPathPrefix)(ad, `/${$}`) : ad),
            ...
            try {
              let a = E.method || "GET",
                ...
                w = (null == ab ? void 0 : ab.publicRuntimeConfig) || ac.publicRuntimeConfig,
                x = async (f) => {
                  var x, y;
                  let H,
                          ...
                          return await z
                            .render(E, F, {
                              ...
                              renderContext: {
                                isDraftMode: X,
                                isFallback: al,
                                developmentNotFoundSourcePage: (0, h.getRequestMeta)(
                                  E,
                              ...
                              sharedContext: {
                                buildId: L,
                                customServer: !!(null == ab ? void 0 : ab.isCustomServer) || void 0,
                                deploymentId: !1,
                              },
                              renderOpts: {
                                params: N,
                                ...
                                nextScriptWorkers: !!ac.experimental.nextScriptWorkers,
                                domainLocales: null == (d = ac.i18n) ? void 0 : d.domains,
                                crossOrigin: ac.crossOrigin,
                                multiZoneDraftMode: !1,
                                basePath: ac.basePath,
                                canonicalBase: ac.amp.canonicalBase || "",
                                ampOptimizerConfig:
                                  null == (n = ac.experimental.amp) ? void 0 : n.optimizer,
                                disableOptimizedLoading: ac.experimental.disableOptimizedLoading,
                                largePageDataBytes: ac.experimental.largePageDataBytes,
                                runtimeConfig: Object.keys(w).length > 0 ? w : void 0,
                                ...
                                resolvedAsPath:
                                  af || ai
                                    ? (0, g.formatUrl)({
                                        pathname: am ? (0, k.normalizeDataPath)(Q) : Q,
                                        query: P,
                                      })
                                    : u,
                                isOnDemandRevalidate: Y,
                                ErrorDebug: (0, h.getRequestMeta)(E, "PagesErrorDebug"),
                                ...
                                ampSkipValidation:
                                  null == (o = ac.experimental.amp) ? void 0 : o.skipValidation,
                                ampValidator: (0, h.getRequestMeta)(E, "ampValidator"),
                              },
                            })
                            .then((a) => {
                              let { metadata: b } = a,
                            ...
                            .finally(() => {
                              if (!f) return;
                              f.setAttributes({ "http.status_code": F.statusCode, "next.rsc": !1 });
                              let b = aq.getRootSpanAttributes();
                              if (!b) return;
                              if (b.get("next.span_type") !== e.BaseServerSpan.handleRequest)
                        ...
                        let a = await z
                          ...
                          .get(
                              ...
                              z.isDev ? o() : (0, t.toResponseCacheEntry)(a),
                            {
                              ...
                              incrementalCache: await z.getIncrementalCache(E, ac, W),
                              waitUntil: G.waitUntil,
                            },
                          );
                        if (a) return (delete a.cacheControl, (a.isMiss = !0), a);
                      }
                      return !(0, h.getRequestMeta)(E, "minimalMode") && Y && Z && !m
                        ? ((F.statusCode = 404),
                          F.setHeader("x-nextjs-cache", "REVALIDATED"),
                          F.end("This page could not be found"),
                          null)
                        : al &&
                            (null == m || null == (n = m.value) ? void 0 : n.kind) ===
                              l.CachedRouteKind.PAGES
                          ? {
                              value: {
                                kind: l.CachedRouteKind.PAGES,
                  ...
                  if ((!al || (null == K ? void 0 : K.isMiss) || (al = !1), K)) {
                    if (
                      (ag &&
                        !(0, h.getRequestMeta)(E, "minimalMode") &&
                        F.setHeader(
                          "x-nextjs-cache",
                          Y ? "REVALIDATED" : K.isMiss ? "MISS" : K.isStale ? "STALE" : "HIT",
                        ),
                      !ag || al)
                    )
                      F.getHeader("Cache-Control") || (H = { revalidate: 0, expire: void 0 });
                    else if (an) {
                      ...
                      if ("number" == typeof K.cacheControl.revalidate) {
                        ...
                        H = {
                          ...
                          expire:
                            (null == (x = K.cacheControl) ? void 0 : x.expire) ?? ac.expireTime,
                        };
                      } else H = { revalidate: p.CACHE_ONE_YEAR, expire: void 0 };
                    if (
                      (H &&
                        !F.getHeader("Cache-Control") &&
                        F.setHeader("Cache-Control", (0, m.getCacheControlHeader)(H)),
                      !K.value)
                    )
                        ...
                        return (
                          await ((a) => {
                            ...
                            (d &&
                              ...
                              b.destination.startsWith("/") &&
                                (b.destination = (0, n.normalizeRepeatedSlashes)(b.destination)),
                              (F.statusCode = c),
                              F.setHeader("Location", b.destination),
                              c === v.RedirectStatusCode.PermanentRedirect &&
                                F.setHeader("Refresh", `0;url=${b.destination}`),
                              F.end(b.destination));
                          })(K.value.props),
                          null
                        );
                      else {
                        (F.setHeader("content-type", p.JSON_CONTENT_TYPE_HEADER),
                    ...
                    if (
                      (z.isDev && F.setHeader("Cache-Control", "no-store, must-revalidate"),
                      X &&
                        F.setHeader(
                          "Cache-Control",
                      ...
                      (0, h.getRequestMeta)(E, "customErrorRender") ||
                        (ap && (0, h.getRequestMeta)(E, "minimalMode") && 500 === F.statusCode))
                    )
                      return null;
        ...
        function f(a) {
          ...
          ((b = b ? encodeURIComponent(b).replace(/%3A/i, ":") + "@" : ""),
            a.host
              ? (j = b + a.host)
              : c &&
                ((j = b + (~c.indexOf(":") ? "[" + c + "]" : c)), a.port && (j += ":" + a.port)),
      ...
      30012: (a, b, c) => {
        ...
        function g(a, b) {
          return (
            b && (a = a.replace(/\^/, `^(?!${b.map((a) => a.replace(/\//g, "\\/")).join("|")})`)),
            (a = a.replace(/\$$/, "(?:\\/)?$"))
          );
        }
      },
...
Read more at https://nextjs.org/docs/messages/missing-root-layout-tags"
      ...
      57043: (a, b, c) => {
        "use strict";
        a.exports = c(63885).vendored.contexts.AmpContext;
      },
      64971: (a, b, c) => {
        "use strict";
        (Object.defineProperty(b, "__esModule", { value: !0 }),
      ...
      95e3: (a, b, c) => {
        ...
        function e(a) {
          return (0, d.pathHasPrefix)(a || "/", "/_next/data") &&
            "/index" === (a = a.replace(/\/_next\/data\/[^/]{1,}/, "").replace(/\.json$/, ""))
            ? "/"
            : a;
        }
      },
