  ...
  [9924],
  {
    9924: (t, e, i) => {
      ...
      let o = [
        ...
        h = { test: (t) => "number" == typeof t, parse: parseFloat, transform: (t) => t },
        ...
        P = w("vh"),
        A = w("vw"),
        E = { ...b, parse: (t) => b.parse(t) / 100, transform: (t) => b.transform(100 * t) },
        M = {
          test: f("hsl", "hue"),
        ...
        V = {
          ...
          parse: (t) => (v.test(t) ? v.parse(t) : M.test(t) ? M.parse(t) : x.parse(t)),
          transform: (t) =>
            "string" == typeof t ? t : t.hasOwnProperty("red") ? v.transform(t) : M.transform(t),
          getAnimatableNone: (t) => {
            let e = V.parse(t);
              ...
              (t) => (
                V.test(t)
                  ...
                  : t.startsWith("var(")
                    ...
                    : (n.number.push(r), s.push(k), i.push(parseFloat(t))),
                ++r,
                "${}"
              ),
            )
      ...
      function B({ split: t, types: e }) {
        ...
        return (n) => {
          ...
          for (let r = 0; r < i; r++)
            if (((s += t[r]), void 0 !== n[r])) {
              let t = e[r];
              t === k ? (s += c(n[r])) : t === D ? (s += V.transform(n[r])) : (s += n[r]);
            }
          return s;
        };
      }
      let j = {
          test: function (t) {
            return (
              isNaN(t) &&
              "string" == typeof t &&
              (t.match(p)?.length || 0) + (t.match(C)?.length || 0) > 0
            );
          },
          parse: function (t) {
            return L(t).values;
      ...
      let O = /\b([a-z-]*)\(.*?\)/gu,
        ...
        G = () => ({ x: K(), y: K() }),
        q = (t) => !!(t && t.getVelocity),
        _ = new Set(["width", "height", "top", "left", "right", "bottom", ...o]),
        Z = (t) => (e) => e.test(t),
        Q = [h, S, b, T, A, P, { test: (t) => "auto" === t, parse: (t) => t }],
        J = (t) => Q.find(Z(t));
      i(95704);
      let tt = () => {},
        te = () => {},
                ...
                let u = {
                  ...
                  process: (t) => {
                    ...
                    ((i = n),
                      (n = o),
                      i.forEach(h),
                      e && tM.value && tM.value.frameloop[e].push(l),
                      (l = 0),
                      i.clear(),
                      (s = !1),
                      r && ((r = !1), u.process(t)));
      ...
      let {
          ...
          state: tD,
          steps: tR,
        } = tV("undefined" != typeof requestAnimationFrame ? requestAnimationFrame : tP, !0),
        tL = new Set(),
        tB = !1,
        tj = !1,
        tF = !1;
      function tI() {
        if (tj) {
          let t = Array.from(tL).filter((t) => t.needsMeasurement),
        ...
        ((tj = !1), (tB = !1), tL.forEach((t) => t.complete(tF)), tL.clear());
      }
      function tO() {
        tL.forEach((t) => {
      ...
      class tU {
        ...
        scheduleResolve() {
          ((this.state = "scheduled"),
            this.isAsync
              ? (tL.add(this), tB || ((tB = !0), tC.read(tO), tC.resolveKeyframes(tI)))
        ...
        cancel() {
          "scheduled" === this.state && (tL.delete(this), (this.state = "pending"));
        }
        resume() {
      ...
      function t$(t, e) {
        let i = Y(t);
        return (tN.has(i) || (i = j), i.getAnimatableNone ? i.getAnimatableNone(e) : void 0);
      }
      ...
      class tY extends tU {
        ...
        readKeyframes() {
          ...
          if ((this.resolveNoneKeyframes(), !_.has(i) || 2 !== t.length)) return;
          let [n, s] = t,
            r = J(n),
            o = J(s);
          if (tl(n) !== tl(s) && tS[i]) {
        ...
        resolveNoneKeyframes() {
          ...
          i.length &&
            (function (t, e, i) {
              ...
              for (; s < t.length && !n; ) {
                let e = t[s];
                ("string" == typeof e && !tz.has(e) && L(e).values.length && (n = t[s]), s++);
              }
              if (n && i) for (let s of e) t[s] = t$(i, n);
            })(t, i, e);
        }
        measureInitialState() {
      ...
      class tG {
        ...
        add(t) {
          return (tH(this.subscriptions, t), () => tK(this.subscriptions, t));
        }
        notify(t, e, i) {
      ...
      let tJ = tQ(() => void 0 !== window.ScrollTimeline, "scrollTimeline"),
        t0 = (t) => null !== t;
      function t1(t, { repeat: e, repeatType: i = "loop" }, n, s = 1) {
        let r = t.filter(t0),
      ...
      let t2 = { layout: 0, mainThread: 0, waapi: 0 },
        t3 = (t) => Array.isArray(t) && "number" == typeof t[0],
        t9 = tQ(() => {
          try {
      ...
      class et extends t5 {
        constructor(t) {
          ...
          ((this.animation = (function (
            ...
            (Array.isArray(d) && (u.easing = d), tM.value && t2.waapi++);
            let c = {
              delay: n,
              duration: s,
            ...
            (this.animation.onfinish = () => {
              if (((this.finishedTime = this.time), !s)) {
                let t = t1(n, this.options, o, this.speed);
        ...
        set time(t) {
          ...
          ((this.manualStartTime = null),
            (this.finishedTime = null),
            (this.animation.currentTime = tX(t)),
      ...
      let ee = new Set(["opacity", "clipPath", "filter", "transform"]),
        { schedule: ei } = tV(queueMicrotask, !1);
      function en() {
        n = void 0;
      }
      let es = {
          now: () => (
            void 0 === n &&
              es.set(tD.isProcessing || tA.useManualTiming ? tD.timestamp : performance.now()),
            n
          ),
          set: (t) => {
      ...
      let ec = [
        ...
        ep = ["initial", ...ec];
      function em(t) {
        return eu(t.animate) || ep.some((e) => ed(t[e]));
      }
      function ef(t) {
      ...
      class eS {
                      ...
                      if (((eg.current = !0), ev))
                        if (window.matchMedia) {
                          let t = window.matchMedia("(prefers-reduced-motion)"),
                            e = () => (ey.current = t.matches);
                          (t.addEventListener("change", e), e());
                        } else ey.current = !1;
                    })(),
                  (this.shouldReduceMotion = ey.current)),
        ...
        bindToMotionValue(t, e) {
          ...
          if (
            ...
            e.accelerate && ee.has(t) && this.current instanceof HTMLElement)
          ) {
        ...
        update(t, e) {
          ...
          ((this.prevMotionValues = (function (t, e, i) {
            for (let n in e) {
              let s = e[n],
                r = i[n];
              if (q(s)) t.addValue(n, s);
              else if (q(r)) t.addValue(n, ea(s, { owner: t }));
              else if (r !== s)
                if (t.hasValue(n)) {
                  let e = t.getValue(n);
                  ...
                  t.addValue(n, ea(void 0 !== e ? e : s, { owner: t }));
                }
            }
        ...
        getValue(t, e) {
          ...
          return (
            void 0 === i &&
              void 0 !== e &&
              ((i = ea(null === e ? void 0 : e, { owner: this })), this.addValue(t, i)),
            i
          );
        }
        readValue(t, e) {
          let i =
            void 0 === this.latestValues[t] && this.current
              ...
              : this.latestValues[t];
          if (null != i) {
            if ("string" == typeof i && (ti(i) || tW(i))) i = parseFloat(i);
            else {
              let n;
              ((n = i), !el.find(Z(n)) && j.test(e) && (i = t$(t, e)));
            }
        ...
        on(t, e) {
          return (this.events[t] || (this.events[t] = new tG()), this.events[t].add(e));
        }
        notify(t, ...e) {
      ...
      let ek = { offset: "stroke-dashoffset", array: "stroke-dasharray" },
        eD = { offset: "strokeDashoffset", array: "strokeDasharray" },
        eR = ["offsetDistance", "offsetPath", "offsetRotate", "offsetAnchor"];
      function eL(
        t,
        {
          attrX: e,
      ...
      function e$(t, e, i) {
        ...
        if (!n) return r;
        for (let e in n)
          (q(n[e]) || (s && q(s[e])) || eN(e, t) || i?.getValue(e)?.liveStyle !== void 0) &&
            (r[e] = n[e]);
        return r;
      }
      function ez(t, e, i) {
        ...
        for (let i in t)
          (q(t[i]) || q(e[i])) &&
            (n[-1 !== o.indexOf(i) ? "attr" + i.charAt(0).toUpperCase() + i.substring(1) : i] =
              t[i]);
        return n;
      }
      class eY extends eP {
        ...
        readValueFromInstance(t, e) {
          ...
          return ((e = eB.has(e) ? e : eA(e)), t.getAttribute(e));
        }
        scrapeMotionValuesFromProps(t, e, i) {
          return ez(t, e, i);
        }
        ...
        renderInstance(t, e, i, n) {
          for (let i in (eF(t, e, void 0, n), e.attrs))
            t.setAttribute(eB.has(i) ? i : eA(i), e.attrs[i]);
        }
        mount(t) {
      ...
      function eK({ scale: t, scaleX: e, scaleY: i }) {
        return !eH(t) || !eH(e) || !eH(i);
      }
      function eG(t) {
        return eK(t) || eq(t) || t.z || t.rotate || t.rotateX || t.rotateY || t.skewX || t.skewY;
      }
      function eq(t) {
        var e, i;
      ...
      function eZ(t, e = 0, i = 1, n, s) {
        ((t.min = e_(t.min, e, i, n, s)), (t.max = e_(t.max, e, i, n, s)));
      }
      ...
      function e0(t, e, i, n, s = 0.5) {
        let r = eU(t.min, t.max, s);
        eZ(t, e, i, r, n);
      }
      function e1(t, e) {
      ...
      function e5(t, e, i) {
        let n = i ?? t;
        (e0(t.x, e1(e.x, n.x), e.scaleX, e.scale, e.originX),
          e0(t.y, e1(e.y, n.y), e.scaleY, e.scale, e.originY));
      }
      function e2(t, e) {
        return eX(
          (function (t, e) {
      ...
      function e6(t) {
        ...
        else if (e4.indexOf(t) > -1 || /[A-Z]/u.test(t)) return !0;
        return !1;
      }
      var e8 = i(95155),
        e7 = i(60296);
      let it = (0, e9.createContext)({ strict: !1 });
      var ie = i(53127);
      let ii = (0, e9.createContext)({});
      function is(t) {
        return Array.isArray(t) ? t.join(" ") : t;
      }
      let ir = () => ({ style: {}, transform: {}, transformOrigin: {}, vars: {} });
      function io(t, e, i) {
        for (let n in e) q(e[n]) || eN(n, i) || (t[n] = e[n]);
      }
      let ia = () => ({ ...ir(), attrs: {} }),
        il = new Set([
          "animate",
      ...
      try {
        !(function (t) {
          "function" == typeof t && (iu = (e) => (e.startsWith("on") ? !ih(e) : t(e)));
      ...
      var ic = i(59686),
        ip = i(94416);
      let im = (t) => (e, i) => {
          let n = (0, e9.useContext)(ii),
            s = (0, e9.useContext)(ic.t),
            r = () =>
              (function (t, e, i, n) {
        ...
        iy = im({ scrapeMotionValuesFromProps: e$, createRenderState: ir }),
        ig = im({ scrapeMotionValuesFromProps: ez, createRenderState: ia }),
        iv = {
          animation: [
            "animate",
            "variants",
      ...
      function iw() {
        return (
          !(function () {
            if (ix) return;
            let t = {};
            for (let e in iv) t[e] = { isEnabled: (t) => iv[e].some((e) => !!t[e]) };
            ((eb = t), (ix = !0));
          })(),
          eb
        );
      ...
      let iT = Symbol.for("motionComponentSymbol"),
        ib = "data-" + eA("framerAppearId"),
        iS = (0, e9.createContext)({});
      function iP(t) {
      ...
      function iE(t) {
        ...
        function h(e, i) {
          let s,
            r = {
              ...(0, e9.useContext)(ie.Q),
              ...e,
              layoutId: (function (t) {
                let { layoutId: e } = t,
                  i = (0, e9.useContext)(e7.L).id;
            ...
            u = (function (t) {
              let { initial: e, animate: i } = (function (t, e) {
                if (em(t)) {
                  ...
                  return { initial: !1 === e || ed(e) ? e : void 0, animate: ed(i) ? i : void 0 };
                }
                return !1 !== t.inherit ? e : {};
              })(t, (0, e9.useContext)(ii));
              return (0, e9.useMemo)(() => ({ initial: e, animate: i }), [is(e), is(i)]);
            })(e),
            d = l(e, h);
          if (!h && "undefined" != typeof window) {
            (0, e9.useContext)(it).strict;
            let e = (function (t) {
              let { drag: e, layout: i } = iw();
              if (!e && !i) return {};
              let n = { ...e, ...i };
              return {
                MeasureLayout:
            ...
            ((s = e.MeasureLayout),
              (u.visualElement = (function (t, e, i, n, s, r) {
                var o, a, l, h;
                let { visualElement: u } = (0, e9.useContext)(ii),
                  d = (0, e9.useContext)(it),
                  c = (0, e9.useContext)(ic.t),
                  p = (0, e9.useContext)(ie.Q),
                  m = p.reducedMotion,
                  f = p.skipAnimations,
                  y = (0, e9.useRef)(null),
                  g = (0, e9.useRef)(!1);
                ((n = n || d.renderer),
                  !y.current &&
                    ...
                    g.current && y.current && (y.current.manuallyAnimateOnMount = !0)));
                let v = y.current,
                  x = (0, e9.useContext)(iS);
                v &&
                  !v.projection &&
                  s &&
          ...
          return (0, e8.jsxs)(ii.Provider, {
            value: u,
            children: [
              s && u.visualElement
                ? (0, e8.jsx)(s, { visualElement: u.visualElement, ...r })
                : null,
              (function (t, e, i, n, s) {
                let { latestValues: r } = n,
                    ...
                    (null != a ? a : e6(t))
                      ? function (t, e, i, n) {
                          let s = (0, e9.useMemo)(() => {
                            let i = ia();
                            return (
                              eL(i, e, ej(n), t.transformTemplate, t.style),
                              { ...i.attrs, style: { ...i.style } }
                            );
                          }, [e]);
                          if (t.style) {
                            let e = {};
                            (io(e, t.style, t), (s.style = { ...e, ...s.style }));
                          }
                          return s;
                        }
                      : function (t, e) {
                              ...
                              return (
                                ...
                                Object.assign(
                                  ...
                                  (function (t, e) {
                                    ...
                                    return (0, e9.useMemo)(() => {
                                      let t = ir();
                                      return (eC(t, e, i), Object.assign({}, t.vars, t.style));
                                    }, [e]);
                                  })(t, e),
                                ),
                                n
                  ...
                  u = t !== e9.Fragment ? { ...h, ...l, ref: i } : {},
                  { children: d } = e,
                  c = (0, e9.useMemo)(() => (q(d) ? d.get() : d), [d]);
                return (0, e9.createElement)(t, { ...u, children: c });
              })(
                t,
                e,
                (function (t, e, i) {
                  ...
                  let s = (0, e9.useRef)(null);
                  return (0, e9.useCallback)(
                    (i) => {
                      if (i) {
                        var r;
            ...
            (i = (function ({ hue: t, saturation: e, lightness: i, alpha: n }) {
              ...
              if ((e /= 100)) {
                let n = i < 0.5 ? i * (1 + e) : i + e - i * e,
                  a = 2 * i - n;
                ((s = ij(a, n, t + 1 / 3)), (r = ij(a, n, t)), (o = ij(a, n, t - 1 / 3)));
              } else s = r = o = i;
              return {
      ...
      let iW = (t, e) => {
          let i = iU(t),
            n = iU(e);
          if (!i || !n) return iF(t, e);
          let s = { ...i };
          return (t) => (
            (s.red = iI(i.red, n.red, t)),
            (s.green = iI(i.green, n.green, t)),
            (s.blue = iI(i.blue, n.blue, t)),
            (s.alpha = eU(i.alpha, n.alpha, t)),
            v.transform(s)
          );
        },
      ...
      function iX(t, e) {
        let i = { ...t, ...e },
          n = {};
        for (let s in i) void 0 !== t[s] && void 0 !== e[s] && (n[s] = iz(t[s])(t[s], e[s]));
        return (t) => {
      ...
      let iH = (t, e) => {
        ...
        return n.indexes.var.length === s.indexes.var.length &&
          ...
          ? (iN.has(t) && !s.values.length) || (iN.has(e) && !n.values.length)
            ? (function (t, e) {
                return iN.has(t) ? (i) => (i <= 0 ? t : e) : (i) => (i >= 1 ? e : t);
              })(t, e)
            : iB(
                iY(
                  (function (t, e) {
      ...
      let iQ = ["duration", "bounce"],
        iJ = ["stiffness", "damping", "mass"];
      function i0(t, e) {
        return e.some((e) => void 0 !== t[e]);
      }
      function i1(t = i_.visualDuration, e = i_.bounce) {
        let i,
          n,
          s,
          r,
          o,
          a,
          h = "object" != typeof t ? { visualDuration: t, keyframes: [0, 1], bounce: e } : t,
          ...
          m = { done: !1, value: c },
          {
            ...
            if (!i0(t, iJ) && i0(t, iQ))
              if (((e.velocity = 0), t.visualDuration)) {
                ...
                e = { ...e, mass: i_.mass, stiffness: n, damping: s };
              } else {
                let i = (function ({
                  ...
                  let o = 1 - e;
                  ((o = l(i_.minDamping, i_.maxDamping, o)),
                    (t = l(i_.minDuration, i_.maxDuration, t / 1e3)),
                    o < 1
                      ? ((s = (e) => {
                          let n = e * o,
                            s = n * t;
                  ...
                  if (((t = tX(t)), isNaN(a)))
                    return { stiffness: i_.stiffness, damping: i_.damping, duration: t };
                  {
                    let e = Math.pow(a, 2) * n;
                    return { stiffness: e, damping: 2 * o * Math.sqrt(n * e), duration: t };
                  }
                })({ ...t, velocity: 0 });
                (e = { ...e, ...i, mass: i_.mass }).isResolvedFromDuration = !0;
              }
            return e;
          ...
          A = 5 > Math.abs(S);
        if (
          (u || (u = A ? i_.restSpeed.granular : i_.restSpeed.default),
          d || (d = A ? i_.restDelta.granular : i_.restDelta.default),
          b < 1)
        )
          ((s = iZ(P, b)),
            (r = (T + b * P * S) / s),
            ...
            (o = b * P * r + S * s),
            (a = b * P * S - r * s),
            (n = (t) => Math.exp(-b * P * t) * (o * Math.sin(s * t) + a * Math.cos(s * t))));
        else if (1 === b) {
          ...
          next: (t) => {
            if (!w && b < 1) {
              let e = Math.exp(-b * P * t),
                ...
                l = p - e * (r * i + S * n);
              return (
                (m.done = Math.abs(tX(e * (o * i + a * n))) <= u && Math.abs(p - l) <= d),
                (m.value = m.done ? p : l),
                m
              );
            }
            let e = i(t);
            return (
              w ? (m.done = t >= v) : (m.done = Math.abs(tX(n(t))) <= u && Math.abs(p - e) <= d),
              (m.value = m.done ? p : e),
              m
            );
          },
      ...
      i1.applyToOptions = (t) => {
        ...
        return ((t.ease = e.ease), (t.duration = tX(e.duration)), (t.type = "keyframes"), t);
      };
      let i3 = (t, e, i) => (((1 - 3 * i + 3 * e) * t + (3 * i - 6 * e)) * t + 3 * e) * t;
      function i9(t, e, i, n) {
        return t === e && i === n
          ? tP
          : (s) =>
                ...
                : i3(
                    (function (t, e, i, n, s) {
                      let r,
                        o,
                        a = 0;
                      do (r = i3((o = e + (i - e) / 2), n, s) - t) > 0 ? (i = o) : (e = o);
      ...
      let i4 = i9(0.42, 0, 1, 1),
        i6 = i9(0, 0, 0.58, 1),
        i8 = i9(0.42, 0, 0.58, 1),
        i7 = (t) => (e) => (e <= 0.5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2),
        nt = (t) => (e) => 1 - t(1 - e),
        ne = i9(0.33, 1.53, 0.69, 0.99),
        ni = nt(ne),
        nn = i7(ni),
        ns = (t) =>
          t >= 1 ? 1 : (t *= 2) < 1 ? 0.5 * ni(t) : 0.5 * (2 - Math.pow(2, -10 * (t - 1))),
        ...
        nh = (t) => {
          ...
          return "string" == typeof t
            ? (te(void 0 !== nl[t], `Invalid easing type '${t}'`, "invalid-easing-type"), nl[t])
            : t;
        },
        nu = (t, e, i) => {
          let n = e - t;
      ...
      function nd({ duration: t = 300, keyframes: e, times: i, ease: n = "easeInOut" }) {
        var s;
        let r = Array.isArray(n) && "number" != typeof n[0] ? n.map(nh) : nh(n),
          o = { done: !1, value: e[0] },
          a = (function (t, e, { clamp: i = !0, ease: n, mixer: s } = {}) {
            ...
            let a = (function (t, e, i) {
                ...
                for (let i = 0; i < r; i++) {
                  let r = s(t[i], t[i + 1]);
                  (e && (r = iB(Array.isArray(e) ? e[i] || tP : e, r)), n.push(r));
                }
                return n;
              })(e, n, s),
              h = a.length,
            ...
            s.map((e) => e * t)),
            e,
            { ease: Array.isArray(r) ? r : e.map(() => r || i8).splice(0, e.length - 1) },
          );
        return { calculatedDuration: t, next: (e) => ((o.value = a(e)), (o.done = e >= t), o) };
      }
      let nc = { decay: i2, inertia: i2, tween: nd, keyframes: nd, spring: i1 };
      function np(t) {
        "string" == typeof t.type && (t.type = nc[t.type]);
      }
      let nm = (t) => t / 100;
      class nf extends t5 {
        constructor(t) {
        ...
        initAnimation() {
          ...
          a !== nd &&
            "number" != typeof o[0] &&
            ((this.mixKeyframes = iB(nm, iK(o[0], o[1]))), (o = [0, 100]));
        ...
        tick(t, e = !1) {
          ...
          if (c) {
            ...
            (!i && t >= 1 && (i = 1),
              1 === i && e--,
              (e = Math.min(e, c + 1)) % 2 &&
                ("reverse" === p ? ((i = 1 - i), m && (i -= m / a)) : "mirror" === p && (T = o)),
              (w = l(0, 1, i) * a));
          }
          (x ? ((this.delayState.value = d[0]), (i = this.delayState)) : (i = T.next(w)),
            r && !x && (i.value = r(i.value)));
          let { done: b } = i;
          x ||
            null === h ||
            (b = this.playbackSpeed >= 0 ? this.currentTime >= s : this.currentTime <= 0);
          let S =
            null === this.holdTime &&
            ("finished" === this.state || ("running" === this.state && b));
          return (
            S && f !== i2 && (i.value = t1(d, this.options, g, this.speed)),
            y && y(i.value),
            S && this.finish(),
            i
          );
        ...
        set speed(t) {
          ...
          (e && this.driver && this.updateTime(es.now()),
            (this.playbackSpeed = t),
            e && this.driver && (this.time = this.currentTime / 1e3));
        }
        play() {
          if (this.isStopped) return;
          let { driver: t = iG, startTime: e } = this.options;
        ...
        pause() {
          ((this.state = "paused"), this.updateTime(es.now()), (this.holdTime = this.currentTime));
        }
        complete() {
      ...
      let ny = { anticipate: ns, backInOut: nn, circInOut: na };
      class ng extends et {
        constructor(t) {
          (!(function (t) {
        ...
        updateMotionValue(t) {
          ...
          let o = new nf({ ...r, autoplay: !1 }),
            a = Math.max(10, es.now() - this.startTime),
            h = l(0, 10, a - 10),
            u = o.sample(a).value,
            { name: d } = this.options;
          (s && d && tq(s, d, u),
      ...
      let nv = (t, e) =>
        ...
        !!(
          "number" == typeof t ||
          Array.isArray(t) ||
          ("string" == typeof t && (j.test(t) || "0" === t) && !t.startsWith("url("))
        );
      function nx(t) {
        ((t.duration = 0), (t.type = "keyframes"));
      }
      let nw = /^(?:oklch|oklab|lab|lch|color|color-mix|light-dark)\(/,
        nT = new Set([
          "color",
          "backgroundColor",
          "outlineColor",
        ...
        nb = t_(() => Object.hasOwnProperty.call(Element.prototype, "animate"));
      class nS extends t5 {
        constructor({
          autoplay: t = !0,
          delay: e = 0,
        ...
        onKeyframesResolved(t, e, i, n) {
          ...
          !(function (t, e, i, n) {
            ...
            ((d = !1),
            (tA.instantAnimations || !l) && u?.(t1(t, i, e)),
            (t[0] = t[t.length - 1]),
            nx(i),
            (i.repeat = 0));
          let c = {
                ...
                return (
                  ...
                  (ee.has(i) ||
                    (nT.has(i) &&
                      (function (t) {
                        for (let e = 0; e < t.length; e++)
                          if ("string" == typeof t[e] && nw.test(t[e])) return !0;
                        return !1;
                      })(a))) &&
                  ("transform" !== i || !h) &&
                  !l &&
        ...
        get animation() {
          return (
            this._animation || (this.keyframeResolver?.resume(), (tF = !0), tO(), tI(), (tF = !1)),
            this._animation
          );
        }
        get duration() {
      ...
      let nP = { type: "spring", stiffness: 500, damping: 25, restSpeed: 10 },
        nA = { type: "keyframes", duration: 0.8 },
        nE = { type: "keyframes", ease: [0.25, 0.1, 0.35, 1], duration: 0.3 },
        nM = new Set([
          "when",
          "delay",
          "delayChildren",
        ...
        nV =
          ...
          (o) => {
            ...
            (!(function (t) {
              for (let e in t) if (!nM.has(e)) return !0;
              return !1;
            })(l) &&
              Object.assign(
                d,
              ...
              d.duration && (d.duration = tX(d.duration)),
              d.repeatDelay && (d.repeatDelay = tX(d.repeatDelay)),
              void 0 !== d.from && (d.keyframes[0] = d.from));
            let c = !1;
            if (
              ((!1 !== d.type && (0 !== d.duration || d.repeatDelay)) ||
                (nx(d), 0 === d.delay && (c = !0)),
              (tA.instantAnimations || tA.skipAnimations || s?.shouldSkipAnimations) &&
                ((c = !0), nx(d), (d.delay = 0)),
              (d.allowFlatten = !l.type && !l.ease),
              c && !r && void 0 !== e.get())
            ) {
              let t = t1(d.keyframes, l);
              if (void 0 !== t)
                return void tC.update(() => {
                  (d.onUpdate(t), d.onComplete());
                });
            }
            return l.isSync ? new nf(d) : new nS(d);
          };
      function nC(t, e, { delay: i = 0, transitionOverride: n, type: s } = {}) {
        ...
        for (let e in a) {
          ...
          n.start(nV(e, n, s, p && _.has(e) ? { type: !1 } : o, t, c));
          let m = n.animation;
          m && u.push(m);
        }
        if (o) {
          let e = () =>
            tC.update(() => {
              o &&
                (function (t, e) {
                  let { transitionEnd: i = {}, transition: n = {}, ...s } = iV(t, e) || {};
                  for (let e in (s = { ...s, ...i })) {
                    var r;
                    let i = iD((r = s[e])) ? r[r.length - 1] || 0 : r;
      ...
      function nD(t, e, i = {}) {
        let n = iV(t, e, "exit" === i.type ? t.presenceContext?.custom : void 0),
      ...
      class nO extends iM {
            ...
            t.animationState ||
              (t.animationState = (function (t) {
                let e = (e) =>
                      ...
                      e.map(({ animation: e, options: i }) =>
                        (function (t, e, i = {}) {
                          ...
                          if ((t.notify("AnimationStart", e), Array.isArray(e)))
                            n = Promise.all(e.map((e) => nD(t, e, i)));
                          else if ("string" == typeof e) n = nD(t, e, i);
                          else {
                            let s = "function" == typeof e ? iV(t, e, i.custom) : e;
                  ...
                  s = !1,
                  r = (e) => (i, n) => {
                    let s = iV(t, n, "exit" === e ? t.presenceContext?.custom : void 0);
                    if (s) {
                ...
                function o(o) {
                  ...
                  for (let e = 0; e < nj; e++) {
                    ...
                    let T =
                        ((p = y.prevProp),
                        "string" == typeof (m = g) ? m !== p : !!Array.isArray(m) && !nL(m, p)),
                      b = T || (f === o && y.isActive && !w && v) || (e > c && v),
                      S = !1,
                    ...
                    let { prevResolvedValues: E = {} } = y,
                      M = { ...E, ...A },
                      V = (e) => {
                        ((b = !0), u.has(e) && ((S = !0), u.delete(e)), (y.needsAnimating[e] = !0));
                        let i = t.getValue(e);
                        i && (i.liveStyle = !1);
                      };
                    for (let t in M) {
                        ...
                        ...P.map((e) => {
                          ...
                          if (
                            ...
                            if (n.enteringChildren && s) {
                              ...
                              i.delay = nk(n.enteringChildren, t, e);
                            }
                          }
                  ...
                  if (u.size) {
                    ...
                    if ("boolean" != typeof a.initial) {
                      let i = iV(t, Array.isArray(a.initial) ? a.initial[0] : a.initial);
        ...
        updateAnimationControlsSubscription() {
          ...
          eu(t) && (this.unmountControls = t.subscribe(this.node));
        }
        mount() {
      ...
      class nW extends iM {
        constructor() {
          (super(...arguments), (this.id = nU++), (this.isExitComplete = !1));
        }
        update() {
      ...
      function nY(t, e, i, n = 0.5) {
        ((t.origin = n),
          (t.originPoint = eU(e.min, e.max, t.origin)),
          (t.scale = nz(i) / nz(e)),
          (t.translate = eU(i.min, i.max, t.origin) - t.originPoint),
          ((t.scale >= 0.9999 && t.scale <= 1.0001) || isNaN(t.scale)) && (t.scale = 1),
          ((t.translate >= -0.01 && t.translate <= 0.01) || isNaN(t.translate)) &&
            (t.translate = 0));
      }
      function nX(t, e, i, n) {
        (nY(t.x, e.x, i.x, n ? n.originX : void 0), nY(t.y, e.y, i.y, n ? n.originY : void 0));
      }
      function nH(t, e, i, n = 0) {
        ((t.min = (n ? eU(i.min, i.max, n) : i.min) + e.min), (t.max = t.min + nz(e)));
      }
      function nK(t, e, i, n = 0) {
        let s = n ? eU(i.min, i.max, n) : i.min;
        ((t.min = e.min - s), (t.max = t.min + nz(e)));
      }
      function nG(t, e, i, n) {
        (nK(t.x, e.x, i.x, n?.x), nK(t.y, e.y, i.y, n?.y));
      }
      let nq = new Set(["BUTTON", "INPUT", "SELECT", "TEXTAREA", "A"]),
        n_ = new Set(["INPUT", "SELECT", "TEXTAREA"]);
      function nZ(t, e, i, n = { passive: !0 }) {
        return (t.addEventListener(e, i, n), () => t.removeEventListener(e, i));
      }
      var nQ = i(73142);
      function nJ(t) {
        return (0, nQ.G)(t) && "ownerSVGElement" in t;
      }
      function n0(t, e, i) {
        if (null == t) return [];
      ...
      let n1 = new WeakMap(),
        n5 = (t, e, i) => (n, s) =>
          s && s[0] ? s[0][t + "Size"] : nJ(n) && "getBBox" in n ? n.getBBox()[e] : n[i],
        n2 = n5("inline", "width", "offsetWidth"),
        n3 = n5("block", "height", "offsetHeight");
      function n9({ target: t, borderBoxSize: e }) {
        n1.get(t)?.forEach((i) => {
          i(t, {
            get width() {
              return n2(t, e);
      ...
      function n8(t, e) {
        return "function" == typeof t
          ...
          : (function (t, e) {
              s || ("undefined" != typeof ResizeObserver && (s = new ResizeObserver(n4)));
              let i = n0(t);
              return (
                i.forEach((t) => {
                  let i = n1.get(t);
                  (i || ((i = new Set()), n1.set(t, i)), i.add(e), s?.observe(t));
                }),
                () => {
                  i.forEach((t) => {
                    let i = n1.get(t);
      ...
      function se(t, e, i, n) {
        return nZ(t, e, (t) => n7(t) && i(t, st(t)), n);
      }
      ...
      class sr {
        constructor(
          ...
          if (
            ...
            (this.updatePoint = () => {
              ...
              this.lastRawMoveEventInfo &&
                (this.lastMoveEventInfo = so(this.lastRawMoveEventInfo, this.transformPagePoint));
              let t = sl(this.lastMoveEventInfo, this.history),
                e = null !== this.startEvent,
                i =
                  (function (t, e) {
                    return Math.sqrt(sn(t.x, e.x) ** 2 + sn(t.y, e.y) ** 2);
          ...
          let a = so(st(t), this.transformPagePoint),
            { point: l } = a,
            { timestamp: h } = tD;
          this.history = [{ ...l, timestamp: h }];
          let { onSessionStart: u } = e;
          (u && u(t, sl(a, this.history)),
            (this.removeListeners = iB(
              se(this.contextWindow, "pointermove", this.handlePointerMove),
              se(this.contextWindow, "pointerup", this.handlePointerUp),
              se(this.contextWindow, "pointercancel", this.handlePointerUp),
            )),
        ...
        startScrollTracking(t) {
          ...
          for (; e; ) {
            ...
            ((ss.has(t.overflowX) || ss.has(t.overflowY)) &&
        ...
        return {
          ...
          velocity: (function (t, e) {
            ...
            let i = t.length - 1,
              n = null,
              s = sh(t);
            for (; i >= 0 && ((n = t[i]), !(s.timestamp - n.timestamp > tX(0.1))); ) i--;
            if (!n) return { x: 0, y: 0 };
            n === t[0] && t.length > 2 && s.timestamp - n.timestamp > 2 * tX(e) && (n = t[1]);
      ...
      class sf {
        ...
        start(t, { snapToCursor: e = !1, distanceThreshold: i } = {}) {
          ...
          let s = (t) => {
              (e && this.snapToCursor(st(t).point), this.stopAnimation());
            },
            r = (t, e) => {
              ...
              ((this.latestPointerEvent = t),
                ...
                iR(this.visualElement, "transform"));
        ...
        updateAxis(t, e, i) {
          ...
          if (!i || !sg(t, n, this.currentDirection)) return;
          ...
          (this.constraints &&
            ...
            (r = (function (t, { min: e, max: i }, n) {
              return (
                void 0 !== e && t < e
                  ? (t = n ? eU(e, t, n.min) : Math.max(t, e))
                  : void 0 !== i && t > i && (t = n ? eU(i, t, n.max) : Math.min(t, i)),
                t
              );
          ...
          (t && iP(t)
            ...
            : t && i
              ? (this.constraints = (function (t, { top: e, left: i, bottom: n, right: s }) {
                  return { x: su(t.x, i, s), y: su(t.y, e, n) };
                })(i.layoutBox, t))
              : (this.constraints = !1),
            (this.elastic = (function (t = 0.35) {
              return (
                !1 === t ? (t = 0) : !0 === t && (t = 0.35),
                { x: sc(t, "left", "right"), y: sc(t, "top", "bottom") }
              );
            })(e)),
            n !== this.constraints &&
              !iP(t) &&
        ...
        resolveRefConstraints() {
          ...
          let r = (function (t, e, i) {
            ...
            o = ((t = s.layout.layoutBox), { x: sd(t.x, r.x), y: sd(t.y, r.y) });
          if (i) {
            let t = i(
              (function ({ x: t, y: e }) {
        ...
        startAxisValueAnimation(t, e) {
          ...
          return (iR(this.visualElement, t), i.start(nV(t, i, 0, e, this.visualElement, !1)));
        }
        stopAnimation() {
        ...
        scalePositionWithinConstraints() {
          ...
          if (!iP(e) || !i || !this.constraints) return;
          this.stopAnimation();
          let n = { x: 0, y: 0 };
          n$((t) => {
            ...
            if (e && !1 !== this.constraints) {
              ...
              n[t] = (function (t, e) {
                ...
                return (
                  s > n
                    ? (i = nu(e.min, e.max - n, t.min))
                    : n > s && (i = nu(t.min, t.max - s, e.min)),
                  l(0, 1, i)
                );
        ...
        addListeners() {
          ...
          let e = this.visualElement.current,
            i = se(e, "pointerdown", (t) => {
              let { drag: i, dragListener: n = !0 } = this.getProps(),
                s = t.target,
                r = s !== e && (n_.has(s.tagName) || !0 === s.isContentEditable);
              i && n && !r && this.start(t);
            }),
            n = () => {
          ...
          (s && !s.layout && (s.root && s.root.updateScroll(), s.updateLayout()), tC.read(n));
          let o = nZ(window, "resize", () => this.scalePositionWithinConstraints()),
      ...
      class sv extends iM {
        constructor(t) {
          (super(t),
            (this.removeGroupControls = tP),
            (this.removeListeners = tP),
            (this.controls = new sf(t)));
        }
        mount() {
          let { dragControls: t } = this.node.getProps();
          (t && (this.removeGroupControls = t.subscribe(this.controls)),
            (this.removeListeners = this.controls.addListeners() || tP));
        }
        update() {
          let { dragControls: t } = this.node.getProps(),
      ...
      class sw extends iM {
        constructor() {
          (super(...arguments), (this.removePointerDownListener = tP));
        }
        onPointerDown(t) {
          this.session = new sr(t, this.createPanHandlers(), {
        ...
        mount() {
          this.removePointerDownListener = se(this.node.current, "pointerdown", (t) =>
      ...
      let sT = { hasAnimatedSinceResize: !0, hasEverUpdated: !1 };
      var sb = i(75601);
      let sS = !1;
      class sP extends e9.Component {
        componentDidMount() {
      ...
      function sA(t) {
        let [e, i] = (0, sb.xQ)(),
          n = (0, e9.useContext)(e7.L);
        return (0, e8.jsx)(sP, {
          ...t,
          layoutGroup: n,
          switchLayoutGroup: (0, e9.useContext)(iS),
          isPresent: e,
          safeToRemove: i,
        });
      }
      ...
      function sO(t, e, [i, n, s], r, o) {
        !(function (t, e = 0, i = 1, n = 0.5, s, r = t, o = t) {
          if (
            (b.test(e) && ((e = parseFloat(e)), (e = eU(o.min, o.max, e / 100) - o.min)),
            "number" != typeof e)
          )
            return;
          let a = eU(r.min, r.max, n);
          (t === r && (a -= e), (t.min = sI(t.min, e, i, a, s)), (t.max = sI(t.max, e, i, a, s)));
      ...
      class sq {
        ...
        add(t) {
          ...
          for (let e = this.members.length - 1; e >= 0; e--) {
            ...
            let n = i.instance;
            (n && !1 !== n.isConnected) || i.snapshot || (tK(this.members, i), i.unmount());
          }
          t.scheduleRender();
        }
        remove(t) {
          if (
            (tK(this.members, t), t === this.prevLead && (this.prevLead = void 0), t === this.lead)
          ) {
      ...
      class sZ {
        ...
        forEach(t) {
          (this.isDirty && this.children.sort(s_), (this.isDirty = !1), this.children.forEach(t));
        }
      }
      let sQ = { nodes: 0, calculatedTargetDeltas: 0, calculatedProjections: 0 },
        sJ = ["", "X", "Y", "Z"],
        s0 = 0;
      function s1(t, e, i, n) {
      ...
      function s5({
        ...
        return class {
          constructor(t = {}, i = e?.()) {
            ((this.id = s0++),
              ...
              (this.updateProjection = () => {
                ((this.projectionUpdateScheduled = !1),
                  tM.value && (sQ.nodes = sQ.calculatedTargetDeltas = sQ.calculatedProjections = 0),
                  this.nodes.forEach(s9),
                  this.nodes.forEach(rs),
                  this.nodes.forEach(rr),
                  this.nodes.forEach(s4),
                  tM.addProjectionMetrics && tM.addProjectionMetrics(sQ));
              }),
          ...
          addEventListener(t, e) {
            return (
              this.eventHandlers.has(t) || this.eventHandlers.set(t, new tG()),
          ...
          mount(e) {
            ...
            ((this.isSVG = nJ(e) && !(nJ(e) && "svg" === e.tagName)), (this.instance = e));
                ...
                t(e, () => {
                  ...
                  t !== n &&
                    ...
                    (i = (function (t, e) {
                      ...
                      return (tC.setup(n, !0), () => tk(n));
                    })(s, 250)),
                    sT.hasAnimatedSinceResize &&
                      ((sT.hasAnimatedSinceResize = !1), this.nodes.forEach(rn)));
                }));
            }
                ...
                this.addEventListener(
                  ...
                  ({ delta: t, hasLayoutChanged: e, hasRelativeLayoutChanged: i, layout: n }) => {
                    ...
                    let r = this.options.transition || s.getDefaultTransition() || rd,
                      ...
                      l = !this.targetLayout || !sH(this.targetLayout, n),
                      h = !e && i;
                    if (
                      ...
                      let e = { ...ik(r, "layout"), onPlay: o, onComplete: a };
          ...
          startUpdate() {
            !this.isUpdateBlocked() &&
              ((this.isUpdating = !0), this.nodes && this.nodes.forEach(ro), this.animationId++);
          }
              ...
              (window.MotionCancelOptimisedAnimation &&
                ...
                (function t(e) {
                  ...
                  if (window.MotionHasOptimisedAnimation(n, "transform")) {
                    ...
                    window.MotionCancelOptimisedAnimation(n, "transform", tC, !(t || i));
                  }
                  let { parent: s } = e;
          ...
          update() {
            ...
            if (this.animationId <= this.animationCommitId) return void this.nodes.forEach(rt);
            ((this.animationCommitId = this.animationId),
              ...
              this.clearAllSnapshots());
            let t = es.now();
            ((tD.delta = l(0, 1e3 / 60, t - tD.timestamp)),
              (tD.timestamp = t),
              (tD.isProcessing = !0),
          ...
          clearAllSnapshots() {
            (this.nodes.forEach(s6), this.sharedNodes.forEach(ra));
          }
          scheduleUpdateProjection() {
            this.projectionUpdateScheduled ||
              ((this.projectionUpdateScheduled = !0), tC.preRender(this.updateProjection, !1, !0));
          }
          ...
          removeElementScroll(t) {
            ...
            for (let i = 0; i < this.path.length; i++) {
              ...
              n !== this.root &&
                s &&
                r.layoutScroll &&
                (s.wasRoot && sj(e, t), eJ(e.x, s.offset.x), eJ(e.y, s.offset.y));
            }
            return e;
          }
          applyTransform(t, e = !1, i) {
            ...
            for (let t = 0; t < this.path.length; t++) {
              ...
              (!e &&
                ...
                eG(i.latestValues) && e5(n, i.latestValues, i.layout?.layoutBox));
            }
            return (eG(this.latestValues) && e5(n, this.latestValues, this.layout?.layoutBox), n);
          }
          removeTransform(t) {
            let e = G();
            sj(e, t);
            for (let t = 0; t < this.path.length; t++) {
              ...
              eG(n.latestValues) &&
                (n.instance &&
                  (eK(n.latestValues) && n.updateSnapshot(), sj((i = G()), n.measurePageBox())),
                sN(e, n.latestValues, n.snapshot?.layoutBox, i));
            }
            return (eG(this.latestValues) && sN(e, this.latestValues), e);
          }
          setTargetDelta(t) {
            ((this.targetDelta = t),
          ...
          resolveTargetDelta(t = !1) {
            ...
            if (
              ...
              if (
                (this.target || ((this.target = G()), (this.targetWithTransforms = G())),
                this.relativeTarget &&
              ...
              (this.attemptToResolveRelativeTarget &&
                ...
                tM.value && sQ.calculatedTargetDeltas++);
            }
          }
          getClosestProjectingParent() {
            if (!(!this.parent || eK(this.parent.latestValues) || eq(this.parent.latestValues)))
          ...
          createRelativeTarget(t, e, i) {
            ((this.relativeParent = t),
              ...
              nG(this.relativeTargetOrigin, e, i, this.options.layoutAnchor || void 0),
          ...
          calcProjection() {
                ...
                for (let a = 0; a < o; a++) {
                  ...
                  (!o || !o.props.style || "contents" !== o.props.style.display) &&
                    (n &&
                      ...
                      s.scroll &&
                      s !== s.root &&
                      (eJ(t.x, -s.scroll.offset.x), eJ(t.y, -s.scroll.offset.y)),
                    r && ((e.x *= r.x.scale), (e.y *= r.y.scale), eQ(t, r)),
                    n && eG(s.latestValues) && e5(t, s.latestValues, s.layout?.layoutBox));
                }
            ...
            (this.projectionDelta && this.prevProjectionDelta
              ...
              nX(this.projectionDelta, this.layoutCorrected, a, this.latestValues),
              (this.treeScale.x === r &&
                this.treeScale.y === o &&
              ...
              tM.value && sQ.calculatedProjections++);
          }
          hide() {
            this.isVisible = !1;
          }
              ...
              (this.mixTargetDelta = (e) => {
                ...
                if (
                  ...
                  (nG(
                    ...
                    rh(p.y, m.y, f.y, y),
                    i &&
                      ((h = this.relativeTarget), (c = i), sY(h.x, c.x) && sY(h.y, c.y)) &&
                      (this.isProjectionDirty = !1),
                    i || (i = G()),
                ...
                (l &&
                  ...
                  (function (t, e, i, n, s, r) {
                    s
                      ? ((t.opacity = eU(0, i.opacity ?? 1, sD(n))),
                        (t.opacityExit = eU(e.opacity ?? 1, 0, sR(n))))
                      : r && (t.opacity = eU(e.opacity ?? 1, i.opacity ?? 1, n));
                    for (let s = 0; s < sM; s++) {
                      let r = sE[s],
                        o = sk(e, r),
                        a = sk(i, r);
                      (void 0 !== o || void 0 !== a) &&
                        ...
                        a || (a = 0),
                        0 === o || 0 === a || sC(o) === sC(a)
                          ? ((t[r] = Math.max(eU(sV(o), sV(a), n), 0)),
                            (b.test(a) || b.test(o)) && (t[r] += "%"))
                          : (t[r] = a));
                    }
                    (e.rotate || i.rotate) && (t.rotate = eU(e.rotate || 0, i.rotate || 0, n));
              ...
              (this.pendingAnimation = tC.update(() => {
                ((sT.hasAnimatedSinceResize = !0),
                  ...
                  (this.currentAnimation = (function (t, e, i) {
                    let n = q(t) ? t : ea(t);
                    return (n.start(nV("", n, e, i)), n.animation);
                    ...
                    onComplete: () => {
                      (t2.layout--, t.onComplete && t.onComplete(), this.completeAnimation());
                    },
                  })),
          ...
          applyTransformsToTarget() {
            ...
            if (e && i && n) {
              if (
                ...
                this.layout &&
                n &&
                rf(this.options.animationType, this.layout.layoutBox, n.layoutBox)
              ) {
                i = this.target || G();
              ...
              (sj(e, i),
                e5(e, s),
                nX(this.projectionDeltaWithTransform, this.layoutCorrected, e, s));
            }
          }
          ...
          resetSkewAndRotation() {
            ...
            for (let e = 0; e < sJ.length; e++)
              (s1(`rotate${sJ[e]}`, t, n, this.animationValues),
                s1(`skew${sJ[e]}`, t, n, this.animationValues));
          ...
          applyProjectionStyles(t, e) {
            ...
            if (this.needsReset) {
              ((this.needsReset = !1),
                (t.visibility = ""),
                (t.opacity = ""),
                (t.pointerEvents = id(e?.pointerEvents) || ""),
            ...
            this.options.layoutId &&
              (t.pointerEvents = n === this ? id(e?.pointerEvents) || "" : "none");
          }
          clearSnapshot() {
      ...
      function s3(t) {
        ...
        if (t.isLead() && t.layout && e && t.hasListeners("didUpdate")) {
          ...
          nX(o, i, e.layoutBox);
          let a = H();
          r ? nX(a, t.applyTransform(n, !0), e.measuredBox) : nX(a, i, e.layoutBox);
          let l = !sz(o),
            h = !1;
          if (!t.resumeFrom) {
            ...
            if (n && !n.resumeFrom) {
              ...
              if (s && r) {
                let o = t.options.layoutAnchor || void 0,
                  a = G();
                nG(a, e.layoutBox, s.layoutBox, o);
                let l = G();
                (nG(l, i, r.layoutBox, o),
                  sH(a, l) || (h = !0),
      ...
      function rl(t, e, i) {
        ((t.translate = eU(e.translate, 0, i)),
          (t.scale = eU(e.scale, 1, i)),
          (t.origin = e.origin),
          (t.originPoint = e.originPoint));
      }
      function rh(t, e, i, n) {
        ((t.min = eU(e.min, i.min, n)), (t.max = eU(e.max, i.max, n)));
      }
      function ru(t) {
      ...
      let rd = { duration: 0.45, ease: [0.4, 0, 0.1, 1] },
        ...
        rp = rc("applewebkit/") && !rc("chrome/") ? Math.round : tP;
      function rm(t) {
        ((t.min = rp(t.min)), (t.max = rp(t.max)));
      }
      function rf(t, e, i) {
        return "position" === t || ("preserve-aspect" === t && !(0.2 >= Math.abs(sK(e) - sK(i))));
      }
      function ry(t) {
        return t !== t.root && t.scroll?.wasRoot;
      }
      let rg = s5({
          attachResizeListener: (t, e) => nZ(t, "resize", e),
          measureScroll: () => ({
      ...
      class rb extends iM {
        mount() {
          ...
          t &&
              ...
              return (
                n.forEach((t) => {
                  ...
                  (t.addEventListener(
                    "pointerenter",
                    (n) => {
                      if ("touch" === n.pointerType || nN.x || nN.y) return;
                      r = !1;
                      let o = e(t, n);
            ...
            })(t, (t, e) => (rT(this.node, e, "Start"), (t) => rT(this.node, t, "End"))));
        }
        unmount() {}
      }
      class rS extends iM {
        ...
        mount() {
          this.unmount = iB(
            nZ(this.node.current, "focus", () => this.onFocus()),
            nZ(this.node.current, "blur", () => this.onBlur()),
          );
        }
        unmount() {}
      }
      var rP = i(81402);
      let rA = (t, e) => !!e && (t === e || rA(t, e.parentElement)),
        rE = new WeakSet();
      function rM(t) {
        return (e) => {
          "Enter" === e.key && t(e);
          ...
          this.unmount = (function (t, e, i = {}) {
            let [n, s, r] = rw(t, i),
              o = (t) => {
                ...
                if (!rC(t) || rk.has(t)) return;
                (rE.add(n), i.stopPropagation && rk.add(t));
                let r = e(n, t),
                  o = (t, e) => {
                    (window.removeEventListener("pointerup", a),
                      window.removeEventListener("pointercancel", l),
                      rE.has(n) && rE.delete(n),
                      rC(t) && "function" == typeof r && r(t, { success: e }));
                  },
                  a = (t) => {
                    o(t, n === window || n === document || i.useGlobalTarget || rA(n, t.target));
                  },
                  l = (t) => {
                    o(t, !1);
                  };
            ...
            t,
            (t, e) => (
              rD(this.node, e, "Start"),
              (t, { success: e }) => rD(this.node, t, e ? "End" : "Cancel")
            ),
        ...
        startObserver() {
          ...
          let { viewport: t = {} } = this.node.getProps(),
            ...
            r = {
              ...
              rootMargin: i,
              threshold: "number" == typeof n ? n : rI[n],
            },
            o = (t) => {
          ...
          this.stopObserver = (function (t, e, i) {
            let n = (function ({ root: t, ...e }) {
              ...
              let n = rB.get(i),
                s = JSON.stringify(e);
              return (n[s] || (n[s] = new IntersectionObserver(rF, { root: t, ...e })), n[s]);
            })(e);
            return (
              rL.set(t, i),
              n.observe(t),
              () => {
                (rL.delete(t), n.unobserve(t));
              }
            );
      ...
      let rU = (function (t, e) {
        if ("undefined" == typeof Proxy) return iE;
        let i = new Map(),
          n = (i, n) => iE(i, n, t, e);
        return new Proxy((t, e) => n(t, e), {
          get: (s, r) =>
            "create" === r ? n : (i.has(r) || i.set(r, iE(r, void 0, t, e)), i.get(r)),
        });
      })(
        {
          ...
          hover: { Feature: rb },
          pan: { Feature: sw },
          drag: { Feature: sv, ProjectionNode: rx, MeasureLayout: sA },
          layout: { ProjectionNode: rx, MeasureLayout: sA },
        },
        (t, e) =>
          (e.isSVG ?? e6(t)) ? new eY(e) : new e3(e, { allowProjection: t !== e9.Fragment }),
      );
    },
    46436: (t, e, i) => {
      i.d(e, { E: () => s });
