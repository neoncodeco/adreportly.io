(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [7177],
  {
    ...
    36300: (e, t, r) => {
      ...
      function s(e) {
        let { children: t } = e,
          [r] = (0, i.useState)(() => new n.E());
        return (0, o.jsx)(a.CP, {
          refetchOnWindowFocus: !0,
          children: (0, o.jsx)(l.Ht, { client: r, children: t }),
        });
      }
    },
    59529: (e, t, r) => {
      (Promise.resolve().then(r.t.bind(r, 13673, 23)),
        Promise.resolve().then(r.bind(r, 36300)),
        Promise.resolve().then(r.bind(r, 4249)),
        Promise.resolve().then(r.bind(r, 76924)),
        Promise.resolve().then(r.bind(r, 77845)));
    },
    76924: (e, t, r) => {
      "use strict";
      r.d(t, { A: () => u, AuthProvider: () => s });
      var o = r(95155),
        n = r(12115),
        l = r(96199),
        a = r(20063);
      ...
      function s(e) {
        let { children: t } = e,
          r = (0, a.useRouter)(),
          { data: s, status: u, update: d } = (0, l.wV)(),
          c = (0, n.useMemo)(() => {
            var e, t;
            return (null == s || null == (e = s.user) ? void 0 : e.id)
              ? { id: s.user.id, email: null != (t = s.user.email) ? t : null }
              : null;
          }, [s]),
          g = async (e, t) => {
          ...
          h = async (e, t, r) => {
            var o, n;
            let a = await fetch("/api/auth/register", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
                  email: e,
                  password: t,
                  full_name: null != (o = null == r ? void 0 : r.full_name) ? o : "",
                  organization: null != (n = null == r ? void 0 : r.organization) ? n : "",
                }),
              }),
            ...
            let s = await (0, l.Jv)("credentials", { email: e.trim(), password: t, redirect: !1 });
      ...
      function a(e) {
        ...
        return (
          (0, n.useEffect)(() => {
            ...
            (a(e), document.documentElement.classList.toggle("dark", "dark" === e));
          }, []),
          (0, o.jsx)(l.Provider, {
            value: {
              theme: r,
  ...
  (e) => {
    (e.O(0, [2978, 8720, 6856, 380, 8441, 1255, 7358], () => e((e.s = 59529))), (_N_E = e.O()));
  },
]);
