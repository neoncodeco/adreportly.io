(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [1236],
  {
          ...
          (e = arguments[r]) &&
            (t = (function e(t) {
              ...
              if ("string" == typeof t || "number" == typeof t) a += t;
                ...
                if (Array.isArray(t)) {
                  var n = t.length;
                  for (r = 0; r < n; r++) t[r] && (s = e(t[r])) && (a && (a += " "), (a += s));
    ...
    13747: (e, t, r) => {
      ...
      function f() {
        var e, t, r;
        let f = (0, n.useParams)(),
          p = "string" == typeof (null == f ? void 0 : f.token) ? f.token : "",
        ...
        (0, a.useEffect)(() => {
          ...
          return (
            (async () => {
              try {
                let t = await fetch("/api/shared-campaign/".concat(p), { cache: "no-store" }),
                  r = await t.json();
                e || g(r);
              } catch (t) {
                e || g({ success: !1, error: "Network error" });
              } finally {
                e || y(!1);
              }
            })(),
        ...
        let j =
            null != (r = null == v || null == (e = v.campaign) ? void 0 : e.name)
              ? r
              : "Shared campaign",
          w = (0, a.useMemo)(() => {
            var e;
            let t = null != (e = null == v ? void 0 : v.insights) ? e : [],
              r = (null == t ? void 0 : t.length)
                ? t
                    ...
                    .map((e) => {
                      ...
                      let s = e.date_start;
                      return {
                        label: new Date("".concat(s, "T12:00:00Z")).toLocaleDateString("en-US", {
                          month: "short",
                          day: "numeric",
                        }),
                        spend: Math.round(parseFloat(null != (t = e.spend) ? t : "0") || 0),
                        results: Math.round(parseFloat(null != (r = e.clicks) ? r : "0") || 0),
                      };
                    })
                : [];
            ...
            let s = (function (e) {
              var t, r, s;
              if (1 !== e.length || (null == (t = e[0]) ? void 0 : t.date_start)) return null;
              let a = e[0];
              return [
                {
                  label: "Period",
                  spend: Math.round(parseFloat(null != (r = a.spend) ? r : "0") || 0),
                  results: Math.round(parseFloat(null != (s = a.clicks) ? s : "0") || 0),
                },
              ];
            })(t);
            return null != s ? s : [];
          }, [null == v ? void 0 : v.insights]),
          k = (null == v ? void 0 : v.success) === !1 ? v.error : null;
        return (0, s.jsx)("div", {
                  ...
                  (0, s.jsxs)("div", {
                    ...
                    children: [
                      (0, s.jsx)("span", {
                        ...
                        children: (0, s.jsx)(x.A, { className: "h-5 w-5" }),
                      }),
                      (0, s.jsxs)("div", {
                        children: [
                          (0, s.jsx)("p", {
                          ...
                          (0, s.jsx)("p", {
                            ...
                            children: (null == v || null == (t = v.campaign) ? void 0 : t.objective)
                              ? "Objective: "
                                  .concat(v.campaign.objective, " \xb7 Status: ")
                                  .concat(v.campaign.status)
                              : "Read-only \xb7 token ".concat(
                                  p ? "".concat(p.slice(0, 8), "…") : "—",
                                ),
                          }),
                          (null == v ? void 0 : v.clientEmail)
                            ? (0, s.jsxs)("p", {
                                className: "text-xs text-muted-foreground",
                                children: ["Shared with ", v.clientEmail],
                              })
                            : null,
                        ],
                      }),
    ...
    48111: (e, t, r) => {
      Promise.resolve().then(r.bind(r, 13747));
    },
    56154: (e, t, r) => {
      "use strict";
      r.d(t, { A: () => s });
      let s = (0, r(5121).A)("zap", [
        [
          "path",
          {
  ...
  (e) => {
    (e.O(0, [9924, 1583, 5346, 8441, 1255, 7358], () => e((e.s = 48111))), (_N_E = e.O()));
  },
]);
