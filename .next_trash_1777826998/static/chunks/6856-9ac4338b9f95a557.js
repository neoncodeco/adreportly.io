...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [6856],
  {
    ...
    96199: (e, t, n) => {
      ...
      class R extends h {}
      R.type = "OAuthAccountNotLinked";
      class k extends h {}
      k.type = "OAuthCallbackError";
      class P extends d {}
      P.type = "OAuthProfileParseError";
      class A extends d {}
      A.type = "SessionTokenError";
      class C extends h {}
      C.type = "OAuthSignInError";
      class T extends h {}
      T.type = "EmailSignInError";
      class N extends d {}
      N.type = "SignOutError";
      class I extends d {}
      ...
      function K(e) {
        ...
        return { origin: n.origin, host: n.host, path: s, base: a, toString: () => a };
      }
      var Q = n(95704);
      let Y = {
          baseUrl: K(null != (a = Q.env.NEXTAUTH_URL) ? a : Q.env.VERCEL_URL).origin,
          basePath: K(Q.env.NEXTAUTH_URL).path,
          baseUrlServer: K(
            null != (o = null != (r = Q.env.NEXTAUTH_URL_INTERNAL) ? r : Q.env.NEXTAUTH_URL)
              ? o
              : Q.env.VERCEL_URL,
          ).origin,
          basePathServer: K(null != (i = Q.env.NEXTAUTH_URL_INTERNAL) ? i : Q.env.NEXTAUTH_URL)
            .path,
          _lastSync: 0,
          _session: void 0,
          _getSession: () => {},
      ...
      function et() {
        return (null === Z && (Z = ee()), Z);
      }
      let en = { debug: console.debug, error: console.error, warn: console.warn },
        es = null == (s = c.createContext) ? void 0 : s.call(u, void 0);
      function ea(e) {
      ...
      async function er(e) {
        ...
        return (
          (null == (t = null == e ? void 0 : e.broadcast) || t) &&
            ee().postMessage({ event: "session", data: { trigger: "getSession" } }),
          n
        );
      }
      async function eo() {
      ...
      async function el(e, t, n) {
        var s, a, r;
        let { callbackUrl: o, ...i } = null != t ? t : {},
          { redirect: l = !0, redirectTo: c = null != o ? o : window.location.href, ...u } = i,
          d = z(Y),
          h = await ei();
        if (!h) {
          window.location.href = "".concat(d, "/error");
          return;
        }
        if (!e || !h[e]) {
          let e = "".concat(d, "/signin?").concat(new URLSearchParams({ callbackUrl: c }));
        ...
        if ("webauthn" === p)
          throw TypeError(
            [
              'Provider id "'.concat(e, '" refers to a WebAuthn provider.'),
              'Please use `import { signIn } from "next-auth/webauthn"` instead.',
            ].join("\n"),
          );
        let v = ""
            .concat(d, "/")
            .concat("credentials" === p ? "callback" : "signin", "/")
            .concat(e),
          f = await eo(),
          w = await fetch("".concat(v, "?").concat(new URLSearchParams(n)), {
            method: "post",
            headers: {
              "Content-Type": "application/x-www-form-urlencoded",
              "X-Auth-Return-Redirect": "1",
            },
            body: new URLSearchParams({ ...u, csrfToken: f, callbackUrl: c }),
          }),
          g = await w.json();
        if (l) {
          let e = null != (s = g.url) ? s : c;
          ((window.location.href = e), e.includes("#") && window.location.reload());
          return;
        }
        let y = null != (a = new URL(g.url).searchParams.get("error")) ? a : void 0,
          E = null != (r = new URL(g.url).searchParams.get("code")) ? r : void 0;
        return (
          w.ok && (await Y._getSession({ event: "storage" })),
          { error: y, code: E, status: w.status, ok: w.ok, url: y ? null : g.url }
        );
      }
      async function ec(e) {
        var t, n;
        let {
          ...
          l = await i.json();
        if ((et().postMessage({ event: "session", data: { trigger: "signout" } }), s)) {
          let e = null != (n = l.url) ? n : a;
          ((window.location.href = e), e.includes("#") && window.location.reload());
          return;
        }
        return (await Y._getSession({ event: "storage" }), l);
      }
      function eu(e) {
        if (!es) throw Error("React Context is unavailable in Server Components");
        let { children: t, basePath: n, refetchInterval: s, refetchWhenOffline: a } = e;
        n && (Y.basePath = n);
        let r = void 0 !== e.session;
        Y._lastSync = r ? G() : 0;
        let [o, i] = c.useState(() => (r && (Y._session = e.session), e.session)),
          [u, d] = c.useState(!r);
        (c.useEffect(
          () => (
            (Y._getSession = async function () {
              ...
              try {
                ...
                if (t || void 0 === Y._session) {
                  ((Y._lastSync = G()), (Y._session = await er({ broadcast: !t })), i(Y._session));
                  return;
                }
        ...
        let h = (function () {
            let [e, t] = c.useState("undefined" != typeof navigator && navigator.onLine),
              n = () => t(!0),
              s = () => t(!1);
            return (
              c.useEffect(
        ...
        let v = c.useMemo(
          () => ({
            data: o,
            status: u ? "loading" : o ? "authenticated" : "unauthenticated",
            async update(e) {
              if (u) return;
              d(!0);
              let t = await q(
                ...
                Y,
                en,
                void 0 === e ? void 0 : { body: { csrfToken: await eo(), data: e } },
              );
              return (
                d(!1),
                t &&
                  (i(t), et().postMessage({ event: "session", data: { trigger: "getSession" } })),
                t
              );
            },
          }),
