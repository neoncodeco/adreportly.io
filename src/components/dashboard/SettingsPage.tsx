  ...
  return (
    ...
    >
      <div>
        ...
        <p className="text-xs text-muted-foreground sm:text-sm">Manage your agency profile</p>
      </div>
      ...
      <div className="relative overflow-hidden rounded-3xl border border-border bg-card p-5 shadow-soft sm:p-6">
        ...
        <div className="relative flex items-center gap-4">
          ...
          <div className="min-w-0">
            <p className="truncate text-base font-bold sm:text-lg">{fullName || "Your name"}</p>
