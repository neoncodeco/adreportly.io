...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "AdReportly — Real-time Facebook Ads Insights for Agencies" },
      {
      ...
      { name: "twitter:title", content: "AdReportly — Real-time Facebook Ads Insights for Agencies" },
      { name: "description", content: "AdReportly is a SaaS platform for Facebook Ads analytics, offering real-time ROI tracking and client reporting." },
      { property: "og:description", content: "AdReportly is a SaaS platform for Facebook Ads analytics, offering real-time ROI tracking and client reporting." },
      { name: "twitter:description", content: "AdReportly is a SaaS platform for Facebook Ads analytics, offering real-time ROI tracking and client reporting." },
